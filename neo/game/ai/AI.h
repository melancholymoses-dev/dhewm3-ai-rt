...
{
  public:
    idAASFindAttackPosition(const idAI *self, const idMat3 &gravityAxis, idEntity *target, const idVec3 &targetPos,
...
class idAI : public idActor
{
  public:
    ...
    static bool FindPathAroundObstacles(const idPhysics *physics, const idAAS *aas, const idEntity *ignore,
    ...
    static bool PredictPath(const idEntity *ent, const idAAS *aas, const idVec3 &start, const idVec3 &velocity,
    ...
    static bool TestTrajectory(const idVec3 &start, const idVec3 &end, float zVel, float gravity, float time,
    ...
    static bool PredictTrajectory(const idVec3 &firePos, const idVec3 &target, float projectileSpeed,
  ...
  protected:
    ...
    bool PathToGoal(aasPath_t &path, int areaNum, const idVec3 &origin, int goalAreaNum,
