...
template <class Type> struct idEventFunc
{
...
#define CLASS_DECLARATION(nameofsuperclass, nameofclass)                                                               \
    idTypeInfo nameofclass::Type(#nameofclass, #nameofsuperclass, (idEventFunc<idClass> *)nameofclass::eventCallbacks, \
                                 nameofclass::CreateInstance, (void (idClass::*)(void)) & nameofclass::Spawn,          \
...
class idTypeInfo
{
  public:
    ...
    idTypeInfo(const char *classname, const char *superclass, idEventFunc<idClass> *eventCallbacks,
               idClass *(*CreateInstance)(void), void (idClass::*Spawn)(void),
