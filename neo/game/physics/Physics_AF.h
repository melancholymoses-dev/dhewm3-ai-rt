...
class idAFConstraint_ConeLimit : public idAFConstraint
{
  ...
  public:
    ...
    void Setup(idAFBody *b1, idAFBody *b2, const idVec3 &coneAnchor, const idVec3 &coneAxis, const float coneAngle,
               const idVec3 &body1Axis);
...
class idAFConstraint_PyramidLimit : public idAFConstraint
{
  ...
  public:
    ...
    void Setup(idAFBody *b1, idAFBody *b2, const idVec3 &pyramidAnchor, const idVec3 &pyramidAxis,
               const idVec3 &baseAxis, const float pyramidAngle1, const float pyramidAngle2, const idVec3 &body1Axis);
