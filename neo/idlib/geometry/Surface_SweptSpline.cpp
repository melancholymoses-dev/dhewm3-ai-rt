...
void idSurface_SweptSpline::Tessellate(const int splineSubdivisions, const int sweptSplineSubdivisions)
{
    ...
    sweptSplineDiv = sweptSpline->GetBoundaryType() == idCurve_Spline<idVec4>::BT_CLOSED ? sweptSplineSubdivisions
    ...
    splineDiv =
        spline->GetBoundaryType() == idCurve_Spline<idVec4>::BT_CLOSED ? splineSubdivisions : splineSubdivisions - 1;
    splineMat.Identity();
