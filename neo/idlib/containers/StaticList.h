...
template <class type, int size> class idStaticList
{
  public:
    idStaticList();
...
================
*/
template <class type, int size> ID_INLINE idStaticList<type, size>::idStaticList()
{
    num = 0;
}
...
================
*/
template <class type, int size> ID_INLINE idStaticList<type, size>::idStaticList(const idStaticList<type, size> &other)
{
    *this = other;
}
...
================
*/
template <class type, int size> ID_INLINE idStaticList<type, size>::~idStaticList(void)
{
}
...
================
*/
template <class type, int size> ID_INLINE int idStaticList<type, size>::Num(void) const
{
    return num;
}
...
================
*/
template <class type, int size> ID_INLINE int idStaticList<type, size>::Max(void) const
{
    return size;
}
...
================
*/
template <class type, int size> ID_INLINE size_t idStaticList<type, size>::Allocated(void) const
{
...
================
*/
template <class type, int size> ID_INLINE size_t idStaticList<type, size>::Size(void) const
{
...
================
*/
template <class type, int size> ID_INLINE size_t idStaticList<type, size>::MemoryUsed(void) const
{
...
================
*/
template <class type, int size> ID_INLINE void idStaticList<type, size>::SetNum(int newnum)
{
    assert(newnum >= 0);
    assert(newnum <= size);
    num = newnum;
...
================
*/
template <class type, int size> ID_INLINE type *idStaticList<type, size>::Ptr(void)
{
    return &list[0];
}
...
================
*/
template <class type, int size> ID_INLINE const type *idStaticList<type, size>::Ptr(void) const
{
    return &list[0];
}
...
================
*/
template <class type, int size> ID_INLINE type *idStaticList<type, size>::Alloc(void)
{
    if (num >= size)
    {
        return NULL;
...
================
*/
template <class type, int size> ID_INLINE int idStaticList<type, size>::Append(type const &obj)
{
    assert(num < size);
    if (num < size)
    {
...
================
*/
template <class type, int size> ID_INLINE int idStaticList<type, size>::Insert(type const &obj, int index)
{
    int i;
...
================
*/
template <class type, int size> ID_INLINE int idStaticList<type, size>::Append(const idStaticList<type, size> &other)
{
    int i;
    int n = other.Num();
...
================
*/
template <class type, int size> ID_INLINE int idStaticList<type, size>::FindNull(void) const
{
    int i;
...
================
*/
template <class type, int size> ID_INLINE void idStaticList<type, size>::Swap(idStaticList<type, size> &other)
{
