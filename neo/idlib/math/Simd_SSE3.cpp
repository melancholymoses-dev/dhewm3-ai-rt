...
#define movdhdup(dst, src) _asm _emit 0xF2 _asm _emit 0x0F _asm _emit 0x16 _asm _emit((dst & 7) << 3) | src

// Load Unaligned Integer 128 bits
#define lddqu(dst, src) _asm _emit 0xF2 _asm _emit 0x0F _asm _emit 0xF0 _asm _emit((dst & 7) << 3) | src
...
============
*/
void VPCALL idSIMD_SSE3::TransformVerts(idDrawVert *verts, const int numVerts, const idJointMat *joints,
