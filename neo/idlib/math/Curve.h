...
template <class type> class idCurve
{
  public:
    idCurve(void);
...
====================
*/
template <class type> ID_INLINE idCurve<type>::idCurve(void)
{
    currentIndex = -1;
    changed = false;
}
...
====================
*/
template <class type> ID_INLINE int idCurve<type>::AddValue(const float time, const type &value)
{
    int i;
...
====================
*/
template <class type> ID_INLINE type idCurve<type>::GetCurrentValue(const float time) const
{
    int i;
...
====================
*/
template <class type> ID_INLINE type idCurve<type>::GetCurrentFirstDerivative(const float time) const
{
...
====================
*/
template <class type> ID_INLINE type idCurve<type>::GetCurrentSecondDerivative(const float time) const
{
    return (values[0] - values[0]);
}
...
====================
*/
template <class type> ID_INLINE bool idCurve<type>::IsDone(const float time) const
{
...
====================
*/
template <class type> ID_INLINE float idCurve<type>::GetSpeed(const float time) const
{
    int i;
    float speed;
    type value;
...
====================
*/
template <class type> ID_MAYBE_INLINE float idCurve<type>::GetLengthBetweenKnots(const int i0, const int i1) const
{
    float length = 0.0f;
    for (int i = i0; i < i1; i++)
    {
...
====================
*/
template <class type> ID_INLINE float idCurve<type>::GetLengthForTime(const float time) const
{
    float length = 0.0f;
...
====================
*/
template <class type> ID_INLINE float idCurve<type>::GetTimeForLength(const float length, const float epsilon) const
{
    int i, index;
...
====================
*/
template <class type> ID_INLINE void idCurve<type>::MakeUniform(const float totalTime)
{
    int i, n;
...
====================
*/
template <class type> ID_INLINE void idCurve<type>::SetConstantSpeed(const float totalTime)
{
    int i;
...
====================
*/
template <class type> ID_INLINE void idCurve<type>::ShiftTime(const float deltaTime)
{
...
====================
*/
template <class type> ID_INLINE void idCurve<type>::Translate(const type &translation)
{
...
====================
*/
template <class type> ID_INLINE int idCurve<type>::IndexForTime(const float time) const
{
...
====================
*/
template <class type> ID_INLINE type idCurve<type>::ValueForIndex(const int index) const
{
    int n = values.Num() - 1;
...
====================
*/
template <class type> ID_INLINE float idCurve<type>::TimeForIndex(const int index) const
{
    int n = times.Num() - 1;
...
template <class type> class idCurve_Bezier : public idCurve<type>
{
  public:
    idCurve_Bezier(void);
...
====================
*/
template <class type> ID_INLINE idCurve_Bezier<type>::idCurve_Bezier(void)
{
}
...
====================
*/
template <class type> ID_INLINE type idCurve_Bezier<type>::GetCurrentValue(const float time) const
{
    int i;
    float *bvals;
    type v;
...
====================
*/
template <class type> ID_INLINE type idCurve_Bezier<type>::GetCurrentFirstDerivative(const float time) const
{
    int i;
    float *bvals, d;
    type v;
...
====================
*/
template <class type> ID_INLINE type idCurve_Bezier<type>::GetCurrentSecondDerivative(const float time) const
{
    int i;
    float *bvals, d;
    type v;
...
====================
*/
template <class type> ID_INLINE void idCurve_Bezier<type>::Basis(const int order, const float t, float *bvals) const
{
    int i, j, d;
...
template <class type> class idCurve_QuadraticBezier : public idCurve<type>
{
...
====================
*/
template <class type> ID_INLINE idCurve_QuadraticBezier<type>::idCurve_QuadraticBezier(void)
{
}
...
====================
*/
template <class type> ID_INLINE type idCurve_QuadraticBezier<type>::GetCurrentValue(const float time) const
{
    float bvals[3];
...
====================
*/
template <class type> ID_INLINE type idCurve_QuadraticBezier<type>::GetCurrentFirstDerivative(const float time) const
{
    float bvals[3], d;
    assert(this->values.Num() == 3);
...
====================
*/
template <class type> ID_INLINE type idCurve_QuadraticBezier<type>::GetCurrentSecondDerivative(const float time) const
{
    float bvals[3], d;
    assert(this->values.Num() == 3);
...
====================
*/
template <class type> ID_INLINE void idCurve_QuadraticBezier<type>::Basis(const float t, float *bvals) const
{
...
template <class type> class idCurve_CubicBezier : public idCurve<type>
{
...
====================
*/
template <class type> ID_INLINE idCurve_CubicBezier<type>::idCurve_CubicBezier(void)
{
}
...
====================
*/
template <class type> ID_INLINE type idCurve_CubicBezier<type>::GetCurrentValue(const float time) const
{
    float bvals[4];
    assert(this->values.Num() == 4);
    Basis(time, bvals);
    return (bvals[0] * this->values[0] + bvals[1] * this->values[1] + bvals[2] * this->values[2] +
            bvals[3] * this->values[3]);
}
...
====================
*/
template <class type> ID_INLINE type idCurve_CubicBezier<type>::GetCurrentFirstDerivative(const float time) const
{
    float bvals[4], d;
    assert(this->values.Num() == 4);
    BasisFirstDerivative(time, bvals);
...
====================
*/
template <class type> ID_INLINE type idCurve_CubicBezier<type>::GetCurrentSecondDerivative(const float time) const
{
    float bvals[4], d;
    assert(this->values.Num() == 4);
    BasisSecondDerivative(time, bvals);
...
====================
*/
template <class type> ID_INLINE void idCurve_CubicBezier<type>::Basis(const float t, float *bvals) const
{
...
====================
*/
template <class type> ID_INLINE void idCurve_CubicBezier<type>::BasisFirstDerivative(const float t, float *bvals) const
{
    float s1 = (float)(t - this->times[0]) / (this->times[3] - this->times[0]);
    float s2 = s1 * s1;
...
====================
*/
template <class type> ID_INLINE void idCurve_CubicBezier<type>::BasisSecondDerivative(const float t, float *bvals) const
{
    float s1 = (float)(t - this->times[0]) / (this->times[3] - this->times[0]);
...
template <class type> class idCurve_Spline : public idCurve<type>
{
...
====================
*/
template <class type> ID_INLINE idCurve_Spline<type>::idCurve_Spline(void)
{
...
====================
*/
template <class type> ID_INLINE type idCurve_Spline<type>::ValueForIndex(const int index) const
{
...
====================
*/
template <class type> ID_INLINE float idCurve_Spline<type>::TimeForIndex(const int index) const
{
    ...
    if (index < 0)
    {
        if (boundaryType == BT_CLOSED)
        {
            return (index / this->times.Num()) * (this->times[n] + closeTime) -
                   (this->times[n] + closeTime - this->times[this->times.Num() + index % this->times.Num()]);
        }
        else
        {
...
====================
*/
template <class type> ID_INLINE float idCurve_Spline<type>::ClampedTime(const float t) const
{
...
====================
*/
template <class type> ID_INLINE bool idCurve_Spline<type>::IsDone(const float time) const
{
...
template <class type> class idCurve_NaturalCubicSpline : public idCurve_Spline<type>
{
  public:
...
====================
*/
template <class type> ID_INLINE idCurve_NaturalCubicSpline<type>::idCurve_NaturalCubicSpline(void)
{
}
...
====================
*/
template <class type> ID_INLINE type idCurve_NaturalCubicSpline<type>::GetCurrentValue(const float time) const
{
...
====================
*/
template <class type> ID_INLINE type idCurve_NaturalCubicSpline<type>::GetCurrentFirstDerivative(const float time) const
{
    float clampedTime = this->ClampedTime(time);
    int i = this->IndexForTime(clampedTime);
    float s = time - this->TimeForIndex(i);
...
====================
*/
template <class type> ID_INLINE void idCurve_NaturalCubicSpline<type>::Setup(void) const
{
    if (this->changed)
    {
...
====================
*/
template <class type> ID_INLINE void idCurve_NaturalCubicSpline<type>::SetupFree(void) const
{
    int i;
    float inv;
...
====================
*/
template <class type> ID_INLINE void idCurve_NaturalCubicSpline<type>::SetupClamped(void) const
{
    int i;
    float inv;
    float *d0, *d1, *beta, *gamma;
    ...
    alpha[this->values.Num() - 1] =
        3.0f * (1.0f - inv) * (this->values[this->values.Num() - 1] - this->values[this->values.Num() - 2]);
    ...
    delta[this->values.Num() - 1] =
        inv * (alpha[this->values.Num() - 1] - d0[this->values.Num() - 2] * delta[this->values.Num() - 2]);
...
====================
*/
template <class type> ID_INLINE void idCurve_NaturalCubicSpline<type>::SetupClosed(void) const
{
    int i, j;
    float c0, c1;
    float *d0;
    ...
    c[this->values.Num() - 1] = 3.0f * (c0 * (this->values[1] - this->values[0]) -
...
template <class type> class idCurve_CatmullRomSpline : public idCurve_Spline<type>
{
...
====================
*/
template <class type> ID_INLINE idCurve_CatmullRomSpline<type>::idCurve_CatmullRomSpline(void)
{
}
...
====================
*/
template <class type> ID_INLINE type idCurve_CatmullRomSpline<type>::GetCurrentValue(const float time) const
{
    int i, j, k;
...
====================
*/
template <class type> ID_INLINE type idCurve_CatmullRomSpline<type>::GetCurrentFirstDerivative(const float time) const
{
    int i, j, k;
...
====================
*/
template <class type> ID_INLINE type idCurve_CatmullRomSpline<type>::GetCurrentSecondDerivative(const float time) const
{
    int i, j, k;
    float bvals[4], d, clampedTime;
    type v;
...
template <class type> class idCurve_KochanekBartelsSpline : public idCurve_Spline<type>
{
  ...
  public:
    ...
    virtual int AddValue(const float time, const type &value);
    virtual int AddValue(const float time, const type &value, const float tension, const float continuity,
                         const float bias);
    virtual void RemoveIndex(const int index)
    {
...
====================
*/
template <class type> ID_INLINE idCurve_KochanekBartelsSpline<type>::idCurve_KochanekBartelsSpline(void)
{
}
...
====================
*/
template <class type> ID_INLINE int idCurve_KochanekBartelsSpline<type>::AddValue(const float time, const type &value)
{
    int i;
...
*/
template <class type>
ID_INLINE int idCurve_KochanekBartelsSpline<type>::AddValue(const float time, const type &value, const float tension,
...
====================
*/
template <class type> ID_INLINE type idCurve_KochanekBartelsSpline<type>::GetCurrentValue(const float time) const
{
    int i;
    float bvals[4], clampedTime;
    type v, t0, t1;
...
*/
template <class type>
ID_INLINE void idCurve_KochanekBartelsSpline<type>::BasisFirstDerivative(const int index, const float t,
                                                                         float *bvals) const
{
    float s = (float)(t - this->TimeForIndex(index)) / (this->TimeForIndex(index + 1) - this->TimeForIndex(index));
...
*/
template <class type>
ID_INLINE void idCurve_KochanekBartelsSpline<type>::BasisSecondDerivative(const int index, const float t,
                                                                          float *bvals) const
{
    float s = (float)(t - this->TimeForIndex(index)) / (this->TimeForIndex(index + 1) - this->TimeForIndex(index));
...
template <class type> class idCurve_BSpline : public idCurve_Spline<type>
{
...
====================
*/
template <class type> ID_INLINE idCurve_BSpline<type>::idCurve_BSpline(void)
{
...
====================
*/
template <class type> ID_INLINE type idCurve_BSpline<type>::GetCurrentValue(const float time) const
{
    int i, j, k;
    float clampedTime;
    type v;
...
====================
*/
template <class type> ID_INLINE type idCurve_BSpline<type>::GetCurrentFirstDerivative(const float time) const
{
    int i, j, k;
    float clampedTime;
    type v;
...
====================
*/
template <class type> ID_INLINE type idCurve_BSpline<type>::GetCurrentSecondDerivative(const float time) const
{
    int i, j, k;
    float clampedTime;
    type v;
...
{
    return (Basis(index, order - 1, t) - Basis(index + 1, order - 1, t)) * (float)(order - 1) /
...
template <class type> class idCurve_UniformCubicBSpline : public idCurve_BSpline<type>
{
...
====================
*/
template <class type> ID_INLINE idCurve_UniformCubicBSpline<type>::idCurve_UniformCubicBSpline(void)
{
...
====================
*/
template <class type> ID_INLINE type idCurve_UniformCubicBSpline<type>::GetCurrentValue(const float time) const
{
    int i, j, k;
    float bvals[4], clampedTime;
    type v;
...
*/
template <class type>
ID_INLINE void idCurve_UniformCubicBSpline<type>::BasisFirstDerivative(const int index, const float t,
                                                                       float *bvals) const
{
    float s = (float)(t - this->TimeForIndex(index)) / (this->TimeForIndex(index + 1) - this->TimeForIndex(index));
...
*/
template <class type>
ID_INLINE void idCurve_UniformCubicBSpline<type>::BasisSecondDerivative(const int index, const float t,
                                                                        float *bvals) const
{
    float s = (float)(t - this->TimeForIndex(index)) / (this->TimeForIndex(index + 1) - this->TimeForIndex(index));
    bvals[0] = -s + 1.0f;
...
template <class type> class idCurve_NonUniformBSpline : public idCurve_BSpline<type>
{
...
====================
*/
template <class type> ID_INLINE idCurve_NonUniformBSpline<type>::idCurve_NonUniformBSpline(void)
{
}
...
====================
*/
template <class type> ID_INLINE type idCurve_NonUniformBSpline<type>::GetCurrentValue(const float time) const
{
    int i, j, k;
    float clampedTime;
    type v;
...
====================
*/
template <class type> ID_INLINE type idCurve_NonUniformBSpline<type>::GetCurrentFirstDerivative(const float time) const
{
    int i, j, k;
    float clampedTime;
    type v;
...
====================
*/
template <class type> ID_INLINE type idCurve_NonUniformBSpline<type>::GetCurrentSecondDerivative(const float time) const
{
    int i, j, k;
    float clampedTime;
    type v;
...
*/
template <class type>
ID_INLINE void idCurve_NonUniformBSpline<type>::Basis(const int index, const int order, const float t,
                                                      float *bvals) const
{
    int r, s, i;
    float omega;
...
*/
template <class type>
ID_INLINE void idCurve_NonUniformBSpline<type>::BasisFirstDerivative(const int index, const int order, const float t,
                                                                     float *bvals) const
{
    int i;
...
*/
template <class type>
ID_INLINE void idCurve_NonUniformBSpline<type>::BasisSecondDerivative(const int index, const int order, const float t,
                                                                      float *bvals) const
{
    int i;
...
template <class type> class idCurve_NURBS : public idCurve_NonUniformBSpline<type>
{
...
====================
*/
template <class type> ID_INLINE idCurve_NURBS<type>::idCurve_NURBS(void)
{
}
...
====================
*/
template <class type> ID_INLINE int idCurve_NURBS<type>::AddValue(const float time, const type &value)
{
    int i;
...
====================
*/
template <class type> ID_INLINE type idCurve_NURBS<type>::GetCurrentValue(const float time) const
{
    int i, j, k;
...
====================
*/
template <class type> ID_INLINE type idCurve_NURBS<type>::GetCurrentFirstDerivative(const float time) const
{
    int i, j, k;
...
====================
*/
template <class type> ID_INLINE type idCurve_NURBS<type>::GetCurrentSecondDerivative(const float time) const
{
    int i, j, k;
...
====================
*/
template <class type> ID_INLINE float idCurve_NURBS<type>::WeightForIndex(const int index) const
{
    int n = weights.Num() - 1;
