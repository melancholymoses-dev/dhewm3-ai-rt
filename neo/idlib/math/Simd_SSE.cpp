...
#define KFLOATINITDSS(DST, SRC0, SRC1, COUNT, PRE, POST)                                                               \
    __asm mov ecx, DST __asm shr ecx, 2 __asm mov ebx, COUNT __asm neg ecx __asm mov edx, SRC0 __asm and ecx,          \
        3 __asm mov esi, SRC1 __asm sub ebx, ecx __asm jge noUnderFlow __asm xor ebx, ebx __asm mov ecx,               \
        COUNT __asm noUnderFlow                                                                                        \
        : __asm mov PRE, ecx __asm mov eax, ebx __asm mov edi, DST __asm and eax, 8 - 1 __asm mov POST,                \
          eax __asm and ebx, 0xfffffff8 __asm jle done __asm shl ebx,                                                  \
          2 __asm lea ecx, [ecx * 4 + ebx] __asm neg ebx __asm add edx, ecx __asm add esi, ecx __asm add edi,          \
          ecx __asm mov eax, edx __asm or eax, esi
...
#define KFLOATINITDSS_NA(DST, SRC0, SRC1, COUNT, PRE, POST)                                                            \
    __asm mov eax, COUNT __asm mov PRE, 0 __asm and eax, 8 - 1 __asm mov ebx, COUNT __asm mov POST, eax __asm and ebx, \
        0xfffffff8 __asm je done __asm shl ebx, 2 __asm mov edx, SRC0 __asm mov esi, SRC1 __asm mov edi,               \
        DST __asm add edx, ebx __asm add esi, ebx __asm add edi, ebx __asm mov eax, edx __asm or eax,                  \
...
#define KALUDSS1(OP, DST, SRC0, SRC1) __asm movss xmm2, SRC0 __asm OP##ss xmm2, SRC1 __asm movss DST, xmm2
...
#define KDIVDSS1(DST, SRC0, SRC1)                                                                                      \
    __asm movss xmm2, SRC1 __asm rcpss xmm3, xmm2 __asm mulss xmm2, xmm3 __asm mulss xmm2, xmm3 __asm addss xmm3,      \
        xmm3 __asm subss xmm3, xmm2 __asm mulss xmm3, SRC0 __asm movss DST, xmm3
#define KDIVDSS4(DST, SRC0, SRC1)                                                                                      \
    __asm movups xmm2, SRC1 __asm rcpps xmm3, xmm2 __asm mulps xmm2, xmm3 __asm mulps xmm2, xmm3 __asm addps xmm3,     \
        xmm3 __asm subps xmm3, xmm2 __asm movups xmm2, SRC0 __asm mulps xmm3, xmm2 __asm movups DST, xmm3
#define KF2IDS1(SRC0) __asm movss xmm2, SRC0 __asm cvttps2pi mm2, xmm2 __asm movd[edi + ebx], mm2
#define KF2IDS4(SRC0)                                                                                                  \
    __asm movups xmm2, SRC0 __asm cvttps2pi mm2, xmm2 __asm movq[edi + ebx + 0], mm2 __asm shufps xmm2, xmm2,          \
        SHUFFLEPS(1, 0, 3, 2) __asm cvttps2pi mm2, xmm2 __asm movq[edi + ebx + 8], mm2
#define KISQRTDS1(DST, SRC0)                                                                                           \
    __asm movss xmm2, SRC0 __asm rsqrtss xmm3, xmm2 __asm mulss xmm2, xmm3 __asm mulss xmm2, xmm3 __asm subss xmm2,    \
        xmm1 __asm mulss xmm3, xmm0 __asm mulss xmm3, xmm2 __asm movss DST, xmm3
#define KISQRTDS4(DST, SRC0)                                                                                           \
    __asm movups xmm2, SRC0 __asm rsqrtps xmm3, xmm2 __asm mulps xmm2, xmm3 __asm mulps xmm2, xmm3 __asm subps xmm2,   \
        xmm1 __asm mulps xmm3, xmm0 __asm mulps xmm3, xmm2 __asm movups DST, xmm3
...
#define KFLOATOPER(OPER, OPER4, COUNT)                                                                                 \
    __asm mov ecx, pre __asm mov ebx, COUNT __asm cmp ebx, ecx __asm cmovl ecx, COUNT __asm test ecx,                  \
        ecx __asm je preDone __asm xor ebx, ebx __asm lpPre                                                            \
        : OPER __asm add ebx, 4 __asm dec ecx __asm jg lpPre __asm preDone                                             \
        : __asm mov ecx, post __asm mov ebx, COUNT __asm sub ebx, ecx __asm shl ebx, 2 __asm cmp ecx,                  \
          4 __asm jl post4Done OPER4 __asm sub ecx, 4 __asm add ebx, 4 * 4 __asm post4Done                             \
        : __asm test ecx, ecx __asm je postDone __asm lpPost                                                           \
        : OPER __asm add ebx, 4 __asm dec ecx __asm jg lpPost __asm postDone                                           \
        :

// operate on a constant and a float array
#define KFLOAT_CA(ALUOP, DST, SRC, CONSTANT, COUNT)                                                                    \
    int pre, post;                                                                                                     \
    __asm movss xmm0, CONSTANT __asm shufps xmm0, xmm0, 0 KFLOATINITDS(DST, SRC, COUNT, pre, post) __asm and eax,      \
        15 __asm jne lpNA __asm jmp lpA __asm align 16 __asm lpA                                                       \
        : __asm prefetchnta[edx + ebx + 64] __asm movaps xmm1, xmm0 __asm movaps xmm2,                                 \
          xmm0 __asm ALUOP##ps xmm1, [edx + ebx] __asm ALUOP##ps xmm2, [edx + ebx + 16] __asm movaps[edi + ebx],       \
          xmm1 __asm movaps[edi + ebx + 16], xmm2 __asm add ebx,                                                       \
          16 * 2 __asm jl lpA __asm jmp done __asm align 16 __asm lpNA                                                 \
        : __asm prefetchnta[edx + ebx + 64] __asm movaps xmm1, xmm0 __asm movaps xmm2,                                 \
          xmm0 __asm movups xmm3, [edx + ebx] __asm movups xmm4, [edx + ebx + 16] __asm ALUOP##ps xmm1,                \
          xmm3 __asm ALUOP##ps xmm2, xmm4 __asm movaps[edi + ebx], xmm1 __asm movaps[edi + ebx + 16],                  \
          xmm2 __asm add ebx, 16 * 2 __asm jl lpNA __asm done                                                          \
        : __asm mov edx, SRC __asm mov edi,                                                                            \
          DST __asm KFLOATOPER(KALUDSS1(ALUOP, [edi + ebx], xmm0, [edx + ebx]),                                        \
...
#define KFLOAT_AA(ALUOP, DST, SRC0, SRC1, COUNT)                                                                       \
    ...
    __asm and eax, 15 __asm jne lpNA __asm jmp lpA __asm align 16 __asm lpA                                            \
        : __asm movaps xmm1, [edx + ebx] __asm movaps xmm2, [edx + ebx + 16] __asm ALUOP##ps xmm1,                     \
          [esi + ebx] __asm ALUOP##ps xmm2,                                                                            \
          [esi + ebx + 16] __asm prefetchnta[edx + ebx + 64] __asm prefetchnta[esi + ebx + 64] __asm movaps[edi +      \
                                                                                                            ebx],      \
          xmm1 __asm movaps[edi + ebx + 16], xmm2 __asm add ebx,                                                       \
          16 * 2 __asm jl lpA __asm jmp done __asm align 16 __asm lpNA                                                 \
        : __asm movups xmm1, [edx + ebx] __asm movups xmm2, [edx + ebx + 16] __asm movups xmm3,                        \
          [esi + ebx] __asm movups xmm4,                                                                               \
          [esi + ebx + 16] __asm prefetchnta[edx + ebx + 64] __asm prefetchnta[esi + ebx + 64] __asm ALUOP##ps xmm1,   \
          xmm3 __asm ALUOP##ps xmm2, xmm4 __asm movaps[edi + ebx], xmm1 __asm movaps[edi + ebx + 16],                  \
          xmm2 __asm add ebx, 16 * 2 __asm jl lpNA __asm done                                                          \
        : __asm mov edx, SRC0 __asm mov esi, SRC1 __asm mov edi,                                                       \
          DST KFLOATOPER(KALUDSS1(ALUOP, [edi + ebx], [edx + ebx], [esi + ebx]),                                       \
...
static void Simd_MulAdd(float *dst, const float constant, const float *src, const int count){
    ...
    3 __asm jnz SimdMulAdd8 __asm mov ecx,
    esi __asm xor ecx,
    edi __asm and ecx,
    15 __asm jnz MulAdd8 __asm mov ecx,
    esi __asm and ecx,
    15 __asm neg ecx __asm add ecx,
    16 __asm sub eax,
    ecx __asm add edi,
    ecx __asm add esi,
    ecx __asm neg ecx __asm mov edx,
    eax __asm loopPreMulAdd16 : __asm fld st __asm fmul dword ptr[edi + ecx] __asm fadd dword
        ptr[esi + ecx] __asm fstp dword ptr[esi + ecx] __asm add ecx,
    4 __asm jl loopPreMulAdd16 __asm SimdMulAdd16 : __asm and eax,
    ~15 __asm movss xmm1,
    constant __asm shufps xmm1,
    xmm1,
    0x00 __asm add esi,
    eax __asm add edi,
    eax __asm neg eax __asm align 16 __asm loopMulAdd16 : __asm movaps xmm0,
    [edi + eax] __asm mulps xmm0,
    xmm1 __asm addps xmm0,
    [esi + eax] __asm movaps[esi + eax],
    xmm0 __asm add eax,
    16 __asm jl loopMulAdd16 __asm jmp postMulAdd __asm MulAdd8 : __asm mov ecx,
    esi __asm and ecx,
    7 __asm jz SimdMulAdd8 __asm sub eax,
    ecx __asm add esi,
    ecx __asm add edi,
    ecx __asm neg ecx __asm mov edx,
    eax __asm loopPreMulAdd8 : __asm fld st __asm fmul dword ptr[edi + ecx] __asm fadd dword
        ptr[esi + ecx] __asm fstp dword ptr[esi + ecx] __asm add ecx,
    4 __asm jl loopPreMulAdd8 __asm SimdMulAdd8 : __asm and eax,
    ~15 __asm movss xmm1,
    constant __asm shufps xmm1,
    xmm1,
    0x00 __asm add esi,
    eax __asm add edi,
    eax __asm neg eax __asm align 16 __asm loopMulAdd8 : __asm movlps xmm0,
    ...
    xmm0 __asm add eax,
    16 __asm jl loopMulAdd8 __asm jmp postMulAdd __asm postMulAdd : __asm and edx,
    15 __asm jz MulAddDone __asm add esi,
    edx __asm add edi,
    edx __asm neg edx __asm loopPostMulAdd : __asm fld st __asm fmul dword ptr[edi + edx] __asm fadd dword
...
#define SINGLE_OP(SRC, DEST)                                                                                           \
    __asm movlps xmm0, [SRC] __asm movlps xmm1, [SRC + 8] __asm mulps xmm0, xmm4 __asm mulps xmm1,                     \
        xmm5 __asm addps xmm0, xmm1 __asm movaps xmm1, xmm0 __asm shufps xmm1, xmm1,                                   \
        SHUFFLEPS(1, 1, 1, 1) __asm addss xmm0, xmm1 __asm movss[DEST], xmm0 __asm add SRC, 16 __asm add DEST, 4

#define DUAL_OP(SRC, DEST)                                                                                             \
    __asm movlps xmm0, [SRC] __asm movlps xmm1, [SRC + 8] __asm movhps xmm0, [SRC + 16] __asm movhps xmm1,             \
        [SRC + 24] __asm mulps xmm0, xmm4 __asm mulps xmm1, xmm5 __asm addps xmm0, xmm1 __asm shufps xmm1, xmm0,       \
        SHUFFLEPS(2, 0, 1, 0) __asm shufps xmm0, xmm0, SHUFFLEPS(3, 1, 2, 0) __asm addps xmm0,                         \
        xmm1 __asm movhps[DEST], xmm0 __asm add SRC, 32 __asm add DEST, 8
...
#define COMPARECONSTANT(DST, SRC0, CONSTANT, COUNT, CMP, CMPSIMD, DOFLIP)                                              \
    ...
    {                                                                                                                  \
        ...
        cnt = COUNT >> 2;                                                                                              \
        post = COUNT - (cnt << 2);                                                                                     \
        __asm mov edx, cnt __asm test edx, edx __asm je doneCmp __asm push ebx __asm neg edx __asm mov esi,            \
            SRC0 __asm prefetchnta[esi + 64] __asm movss xmm1, CONSTANT __asm shufps xmm1, xmm1,                       \
            R_SHUFFLEPS(0, 0, 0, 0) __asm mov edi, DST __asm mov ecx, 0x01010101 __asm loopNA                          \
            : __asm movups xmm0, [esi] __asm prefetchnta[esi + 128] __asm CMPSIMD xmm0, xmm1 __asm movmskps eax,       \
              xmm0 __asm DOFLIP __asm mov ah, al __asm shr ah, 1 __asm mov bx, ax __asm shl ebx, 14 __asm mov bx,      \
              ax __asm and ebx, ecx __asm mov dword ptr[edi], ebx __asm add esi, 16 __asm add edi,                     \
    ...
    {                                                                                                                  \
        ...
        {                                                                                                              \
            ...
            __asm mov edx, cnt __asm test edx, edx __asm je doneCmp __asm push ebx __asm neg edx __asm mov esi,        \
                aligned __asm prefetchnta[esi + 64] __asm movss xmm1, CONSTANT __asm shufps xmm1, xmm1,                \
                R_SHUFFLEPS(0, 0, 0, 0) __asm mov edi, DST __asm add edi, pre __asm mov ecx, 0x01010101 __asm loopA    \
                : __asm movaps xmm0, [esi] __asm prefetchnta[esi + 128] __asm CMPSIMD xmm0, xmm1 __asm movmskps eax,   \
                  xmm0 __asm DOFLIP __asm mov ah, al __asm shr ah, 1 __asm mov bx, ax __asm shl ebx, 14 __asm mov bx,  \
                  ax __asm and ebx, ecx __asm mov dword ptr[edi], ebx __asm add esi, 16 __asm add edi,                 \
...
#define COMPAREBITCONSTANT(DST, BITNUM, SRC0, CONSTANT, COUNT, CMP, CMPSIMD, DOFLIP)                                   \
    ...
    {                                                                                                                  \
        ...
        __asm mov edx, cnt __asm test edx, edx __asm je doneCmp __asm push ebx __asm neg edx __asm mov esi,            \
            SRC0 __asm prefetchnta[esi + 64] __asm movss xmm1, CONSTANT __asm shufps xmm1, xmm1,                       \
            R_SHUFFLEPS(0, 0, 0, 0) __asm mov edi, DST __asm mov cl, bitNum __asm loopNA                               \
            : __asm movups xmm0, [esi] __asm prefetchnta[esi + 128] __asm CMPSIMD xmm0, xmm1 __asm movmskps eax,       \
              xmm0 __asm DOFLIP __asm mov ah, al __asm shr ah, 1 __asm mov bx, ax __asm shl ebx, 14 __asm mov bx,      \
              ax __asm and ebx, 0x01010101 __asm shl ebx, cl __asm or ebx, dword ptr[edi] __asm mov dword ptr[edi],    \
              ebx __asm add esi, 16 __asm add edi, 4 __asm inc edx __asm jl loopNA __asm pop ebx                       \
    }                                                                                                                  \
    else                                                                                                               \
    {                                                                                                                  \
        /* aligned memory access */                                                                                    \
        ...
        {                                                                                                              \
            ...
            __asm mov edx, cnt __asm test edx, edx __asm je doneCmp __asm push ebx __asm neg edx __asm mov esi,        \
                aligned __asm prefetchnta[esi + 64] __asm movss xmm1, CONSTANT __asm shufps xmm1, xmm1,                \
                R_SHUFFLEPS(0, 0, 0, 0) __asm mov edi, DST __asm add edi, pre __asm mov cl, bitNum __asm loopA         \
                : __asm movaps xmm0, [esi] __asm prefetchnta[esi + 128] __asm CMPSIMD xmm0, xmm1 __asm movmskps eax,   \
                  xmm0 __asm DOFLIP __asm mov ah, al __asm shr ah, 1 __asm mov bx, ax __asm shl ebx, 14 __asm mov bx,  \
                  ax __asm and ebx, 0x01010101 __asm shl ebx, cl __asm or ebx,                                         \
                  dword ptr[edi] __asm mov dword ptr[edi], ebx __asm add esi, 16 __asm add edi,                        \
                  4 __asm inc edx __asm jl loopA __asm pop ebx                                                         \
        }                                                                                                              \
    }                                                                                                                  \
    doneCmp:                                                                                                           \
...
#define STORE4(offset, reg1, reg2) __asm movlps[eax + offset], reg1 __asm movhps[eax + offset + 8], reg1
#define STOREC =
...
#define STORE4(offset, reg1, reg2)                                                                                     \
    __asm movlps reg2, [eax + offset] __asm movhps reg2, [eax + offset + 8] __asm addps reg2,                          \
        reg1 __asm movlps[eax + offset], reg2 __asm movhps[eax + offset + 8], reg2
#define STOREC +=
...
#define STORE4(offset, reg1, reg2)                                                                                     \
    __asm movlps reg2, [eax + offset] __asm movhps reg2, [eax + offset + 8] __asm subps reg2,                          \
        reg1 __asm movlps[eax + offset], reg2 __asm movhps[eax + offset + 8], reg2
#define STOREC -=
...
#define MUL_Nx2_2x6_INIT                                                                                               \
    __asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax, dstPtr __asm movaps xmm0, [esi] __asm movlps xmm1,        \
        [esi + 16] __asm movhps xmm1, [esi + 40] __asm movlps xmm2, [esi + 24] __asm movhps xmm2, [esi + 32]

#define MUL_Nx2_2x6_ROW2(row)                                                                                          \
    __asm movaps xmm3, [edi + row * 16] __asm movaps xmm5, xmm0 __asm movaps xmm4, xmm3 __asm shufps xmm4, xmm4,       \
        R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm5, xmm4 __asm movaps xmm4, xmm3 __asm movaps xmm6,                      \
        xmm2 __asm shufps xmm4, xmm4, R_SHUFFLEPS(1, 1, 1, 1) __asm mulps xmm6, xmm4 __asm addps xmm5,                 \
        xmm6 __asm movaps[eax + row * 48], xmm5 __asm movaps xmm4, xmm3 __asm shufps xmm4, xmm4,                       \
        R_SHUFFLEPS(0, 0, 1, 1) __asm movaps xmm7, xmm1 __asm mulps xmm7, xmm4 __asm movaps xmm4,                      \
        xmm3 __asm movaps xmm5, xmm0 __asm shufps xmm4, xmm4, R_SHUFFLEPS(2, 2, 2, 2) __asm mulps xmm5,                \
        xmm4 __asm movaps xmm4, xmm3 __asm movaps xmm6, xmm2 __asm shufps xmm4, xmm4,                                  \
        R_SHUFFLEPS(3, 3, 3, 3) __asm mulps xmm6, xmm4 __asm addps xmm5, xmm6 __asm shufps xmm3, xmm3,                 \
        R_SHUFFLEPS(2, 2, 3, 3) __asm movaps xmm6, xmm1 __asm mulps xmm6, xmm3 __asm movaps xmm4,                      \
        xmm7 __asm movlhps xmm7, xmm6 __asm movhlps xmm6, xmm4 __asm addps xmm6,                                       \
        xmm7 __asm movlps[eax + row * 48 + 16], xmm6 __asm movlps[eax + row * 48 + 24],                                \
        xmm5 __asm movhps[eax + row * 48 + 32], xmm5 __asm movhps[eax + row * 48 + 40], xmm6
            ...
            case 6: { // 6x2 * 2x6
                ...
                MUL_Nx2_2x6_INIT MUL_Nx2_2x6_ROW2(0) MUL_Nx2_2x6_ROW2(1) MUL_Nx2_2x6_ROW2(2)
...
#define MUL_Nx3_3x6_FIRST4COLUMNS_INIT                                                                                 \
    __asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax, dstPtr __asm movlps xmm0,                                 \
        [esi + 0 * 4] __asm movhps xmm0, [esi + 2 * 4] __asm movlps xmm1, [esi + 6 * 4] __asm movhps xmm1,             \
        [esi + 8 * 4] __asm movlps xmm2, [esi + 12 * 4] __asm movhps xmm2, [esi + 14 * 4]

#define MUL_Nx3_3x6_FIRST4COLUMNS_ROW(row)                                                                             \
    __asm movss xmm3, [edi + (row * 3 + 0) * 4] __asm shufps xmm3, xmm3, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm3,     \
        xmm0 __asm movss xmm4, [edi + (row * 3 + 1) * 4] __asm shufps xmm4, xmm4,                                      \
        R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm4, xmm1 __asm addps xmm3,                                               \
        xmm4 __asm movss xmm5, [edi + (row * 3 + 2) * 4] __asm shufps xmm5, xmm5,                                      \
        R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm5, xmm2 __asm addps xmm3, xmm5 __asm movlps[eax + (row * 6 + 0) * 4],   \
        xmm3 __asm movhps[eax + (row * 6 + 2) * 4], xmm3

#define MUL_Nx3_3x6_LAST2COLUMNS_ROW6                                                                                  \
    __asm movlps xmm0, [esi + 4 * 4] __asm movlps xmm1, [esi + 10 * 4] __asm movlps xmm2,                              \
        [esi + 16 * 4] __asm shufps xmm0, xmm0, 0x44 __asm shufps xmm1, xmm1, 0x44 __asm shufps xmm2, xmm2,            \
        0x44 __asm movlps xmm3, [edi + 0 * 4] __asm movhps xmm3, [edi + 2 * 4] __asm movaps xmm4,                      \
        xmm3 __asm movaps xmm5, xmm3 __asm shufps xmm3, xmm3, 0xF0 __asm mulps xmm3,                                   \
        xmm0 __asm movlps xmm6, [edi + 4 * 4] __asm movhps xmm6, [edi + 6 * 4] __asm shufps xmm4, xmm6,                \
        0x05 __asm mulps xmm4, xmm1 __asm addps xmm3, xmm4 __asm shufps xmm5, xmm6, 0x5A __asm mulps xmm5,             \
        xmm2 __asm addps xmm3, xmm5 __asm movlps[eax + 4 * 4], xmm3 __asm movhps[eax + 10 * 4],                        \
        xmm3 __asm movaps xmm5,                                                                                        \
        xmm6 __asm movlps xmm3, [edi + 8 * 4] __asm movhps xmm3, [edi + 10 * 4] __asm movaps xmm4,                     \
        xmm3 __asm shufps xmm5, xmm3, 0x5A __asm mulps xmm5, xmm0 __asm shufps xmm6, xmm3, 0xAF __asm mulps xmm6,      \
        xmm1 __asm addps xmm5, xmm6 __asm shufps xmm4, xmm4, 0xF0 __asm mulps xmm4, xmm2 __asm addps xmm4,             \
        xmm5 __asm movlps[eax + 16 * 4], xmm4 __asm movhps[eax + 22 * 4],                                              \
        xmm4 __asm movlps xmm6, [edi + 12 * 4] __asm movhps xmm6, [edi + 14 * 4] __asm movaps xmm5,                    \
        xmm6 __asm movaps xmm4, xmm6 __asm shufps xmm6, xmm6, 0xF0 __asm mulps xmm6,                                   \
        xmm0 __asm movlps xmm3, [edi + 16 * 4] __asm shufps xmm5, xmm3, 0x05 __asm mulps xmm5, xmm1 __asm addps xmm5,  \
        xmm6 __asm shufps xmm4, xmm3, 0x5A __asm mulps xmm4, xmm2 __asm addps xmm4, xmm5 __asm movlps[eax + 28 * 4],   \
        xmm4 __asm movhps[eax + 34 * 4], xmm4

                MUL_Nx3_3x6_FIRST4COLUMNS_INIT MUL_Nx3_3x6_FIRST4COLUMNS_ROW(0) MUL_Nx3_3x6_FIRST4COLUMNS_ROW(1)
                    MUL_Nx3_3x6_FIRST4COLUMNS_ROW(2) MUL_Nx3_3x6_FIRST4COLUMNS_ROW(3) MUL_Nx3_3x6_FIRST4COLUMNS_ROW(4)
                        MUL_Nx3_3x6_FIRST4COLUMNS_ROW(5) MUL_Nx3_3x6_LAST2COLUMNS_ROW6
...
#define MUL_Nx4_4x6_FIRST4COLUMNS_INIT                                                                                 \
    __asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax,                                                           \
        dstPtr __asm movlps xmm0, [esi + 0 * 4] __asm movhps xmm0, [esi + 2 * 4] __asm movlps xmm1,                    \
        [esi + 6 * 4] __asm movhps xmm1, [esi + 8 * 4] __asm movlps xmm2, [esi + 12 * 4] __asm movhps xmm2,            \
        [esi + 14 * 4] __asm movlps xmm3, [esi + 18 * 4] __asm movhps xmm3, [esi + 20 * 4]

#define MUL_Nx4_4x6_FIRST4COLUMNS_ROW(row)                                                                             \
    __asm movss xmm4, [edi + row * 16 + 0 * 4] __asm shufps xmm4, xmm4, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm4,      \
        ...
        R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm7, xmm3 __asm addps xmm4, xmm7 __asm movlps[eax + row * 24 + 0],        \
        xmm4 __asm movhps[eax + row * 24 + 8], xmm4

#define MUL_Nx4_4x6_LAST2COLUMNS_INIT                                                                                  \
    __asm movlps xmm0, [esi + 4 * 4] __asm movlps xmm1, [esi + 10 * 4] __asm movlps xmm2,                              \
        [esi + 16 * 4] __asm movlps xmm3, [esi + 22 * 4] __asm shufps xmm0, xmm1,                                      \
        R_SHUFFLEPS(0, 1, 0, 1) __asm shufps xmm1, xmm0, R_SHUFFLEPS(0, 1, 0, 1) __asm shufps xmm2, xmm3,              \
        R_SHUFFLEPS(0, 1, 0, 1) __asm shufps xmm3, xmm2, R_SHUFFLEPS(0, 1, 0, 1)

#define MUL_Nx4_4x6_LAST2COLUMNS_ROW2(row)                                                                             \
    __asm movlps xmm7, [edi + row * 32 + 0 * 4] __asm movhps xmm7, [edi + row * 32 + 4 * 4] __asm movaps xmm6,         \
        xmm7 __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 3, 3) __asm mulps xmm6, xmm0 __asm shufps xmm7, xmm7,          \
        R_SHUFFLEPS(1, 1, 2, 2) __asm mulps xmm7, xmm1 __asm addps xmm6, xmm7 __asm movlps xmm4,                       \
        [edi + row * 32 + 2 * 4] __asm movhps xmm4, [edi + row * 32 + 6 * 4] __asm movaps xmm5,                        \
        xmm4 __asm shufps xmm5, xmm5, R_SHUFFLEPS(0, 0, 3, 3) __asm mulps xmm5, xmm2 __asm addps xmm6,                 \
        xmm5 __asm shufps xmm4, xmm4, R_SHUFFLEPS(1, 1, 2, 2) __asm mulps xmm4, xmm3 __asm addps xmm6,                 \
        xmm4 __asm movlps[eax + row * 48 + 4 * 4], xmm6 __asm movhps[eax + row * 48 + 10 * 4], xmm6

                MUL_Nx4_4x6_FIRST4COLUMNS_INIT MUL_Nx4_4x6_FIRST4COLUMNS_ROW(0) MUL_Nx4_4x6_FIRST4COLUMNS_ROW(1)
                    MUL_Nx4_4x6_FIRST4COLUMNS_ROW(2) MUL_Nx4_4x6_FIRST4COLUMNS_ROW(3)
                        MUL_Nx4_4x6_LAST2COLUMNS_INIT MUL_Nx4_4x6_LAST2COLUMNS_ROW2(0) MUL_Nx4_4x6_LAST2COLUMNS_ROW2(1)
            ...
            case 6: { // 6x4 * 4x6
                ...
                MUL_Nx4_4x6_FIRST4COLUMNS_INIT MUL_Nx4_4x6_FIRST4COLUMNS_ROW(0) MUL_Nx4_4x6_FIRST4COLUMNS_ROW(1)
                    MUL_Nx4_4x6_FIRST4COLUMNS_ROW(2) MUL_Nx4_4x6_FIRST4COLUMNS_ROW(3) MUL_Nx4_4x6_FIRST4COLUMNS_ROW(4)
                        MUL_Nx4_4x6_FIRST4COLUMNS_ROW(5) MUL_Nx4_4x6_LAST2COLUMNS_INIT MUL_Nx4_4x6_LAST2COLUMNS_ROW2(0)
                            MUL_Nx4_4x6_LAST2COLUMNS_ROW2(1) MUL_Nx4_4x6_LAST2COLUMNS_ROW2(2)
        ...
        for (i = 0; i < k; i++)
        {
            ...
            {
                *dstPtr++ =
                    m1Ptr[0] * m2Ptr[0] + m1Ptr[1] * m2Ptr[l] + m1Ptr[2] * m2Ptr[2 * l] + m1Ptr[3] * m2Ptr[3 * l];
                m2Ptr++;
            }
            m1Ptr += 4;
        }
...
#define MUL_Nx5_5x6_FIRST4COLUMNS_INIT                                                                                 \
    __asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax,                                                           \
        dstPtr __asm movlps xmm0, [esi + 0 * 4] __asm movhps xmm0, [esi + 2 * 4] __asm movlps xmm1,                    \
        [esi + 6 * 4] __asm movhps xmm1, [esi + 8 * 4] __asm movlps xmm2, [esi + 12 * 4] __asm movhps xmm2,            \
        [esi + 14 * 4] __asm movlps xmm3, [esi + 18 * 4] __asm movhps xmm3, [esi + 20 * 4] __asm movlps xmm4,          \
        [esi + 24 * 4] __asm movhps xmm4, [esi + 26 * 4]

#define MUL_Nx5_5x6_FIRST4COLUMNS_ROW(row)                                                                             \
    __asm movss xmm6, [edi + row * 20 + 0 * 4] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6,      \
        ...
        R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm5, xmm4 __asm addps xmm6, xmm5 __asm movlps[eax + row * 24 + 0],        \
        xmm6 __asm movhps[eax + row * 24 + 8], xmm6

#define MUL_Nx5_5x6_LAST2COLUMNS_INIT                                                                                  \
    __asm movlps xmm0, [esi + 4 * 4] __asm movlps xmm1, [esi + 10 * 4] __asm movlps xmm2,                              \
        [esi + 16 * 4] __asm movlps xmm3, [esi + 22 * 4] __asm movlps xmm4, [esi + 28 * 4] __asm shufps xmm0, xmm1,    \
        R_SHUFFLEPS(0, 1, 0, 1) __asm shufps xmm1, xmm2, R_SHUFFLEPS(0, 1, 0, 1) __asm shufps xmm2, xmm3,              \
        R_SHUFFLEPS(0, 1, 0, 1) __asm shufps xmm3, xmm4, R_SHUFFLEPS(0, 1, 0, 1) __asm shufps xmm4, xmm0,              \
        R_SHUFFLEPS(0, 1, 0, 1)

#define MUL_Nx5_5x6_LAST2COLUMNS_ROW2(row)                                                                             \
    __asm movlps xmm7, [edi + row * 40 + 0 * 4] __asm movhps xmm7, [edi + row * 40 + 6 * 4] __asm movaps xmm6,         \
        xmm7 __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 2, 2) __asm mulps xmm6, xmm0 __asm movaps xmm5,                \
        xmm7 __asm shufps xmm5, xmm5, R_SHUFFLEPS(1, 1, 3, 3) __asm mulps xmm5, xmm1 __asm addps xmm6,                 \
        xmm5 __asm movlps xmm7, [edi + row * 40 + 2 * 4] __asm movhps xmm7,                                            \
        [edi + row * 40 + 8 * 4] __asm movaps xmm5, xmm7 __asm shufps xmm5, xmm5,                                      \
        R_SHUFFLEPS(0, 0, 2, 2) __asm mulps xmm5, xmm2 __asm addps xmm6, xmm5 __asm movaps xmm5,                       \
        xmm7 __asm shufps xmm5, xmm5, R_SHUFFLEPS(1, 1, 3, 3) __asm mulps xmm5, xmm3 __asm addps xmm6,                 \
        xmm5 __asm movlps xmm5, [edi + row * 40 + 4 * 4] __asm shufps xmm5, xmm5,                                      \
        R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm5, xmm4 __asm addps xmm6, xmm5 __asm movlps[eax + row * 48 + 4 * 4],    \
        xmm6 __asm movhps[eax + row * 48 + 10 * 4], xmm6

#define MUL_Nx5_5x6_LAST2COLUMNS_ROW(row)                                                                              \
    __asm movlps xmm6, [edi + 20 * 4 + 0 * 4] __asm unpcklps xmm6, xmm6 __asm mulps xmm6,                              \
        xmm0 __asm movlps xmm5, [edi + 20 * 4 + 2 * 4] __asm unpcklps xmm5, xmm5 __asm mulps xmm5,                     \
        xmm2 __asm addps xmm6, xmm5 __asm movss xmm5, [edi + 20 * 4 + 4 * 4] __asm unpcklps xmm5,                      \
        xmm5 __asm mulps xmm5, xmm4 __asm addps xmm6, xmm5 __asm movhlps xmm7, xmm6 __asm addps xmm6,                  \
        xmm7 __asm movlps[eax + row * 24 + 4 * 4], xmm6

                MUL_Nx5_5x6_FIRST4COLUMNS_INIT MUL_Nx5_5x6_FIRST4COLUMNS_ROW(0) MUL_Nx5_5x6_FIRST4COLUMNS_ROW(1)
                    MUL_Nx5_5x6_FIRST4COLUMNS_ROW(2) MUL_Nx5_5x6_FIRST4COLUMNS_ROW(3) MUL_Nx5_5x6_FIRST4COLUMNS_ROW(4)
                        MUL_Nx5_5x6_LAST2COLUMNS_INIT MUL_Nx5_5x6_LAST2COLUMNS_ROW2(0) MUL_Nx5_5x6_LAST2COLUMNS_ROW2(1)
            ...
            case 6: { // 6x5 * 5x6
                ...
                MUL_Nx5_5x6_FIRST4COLUMNS_INIT MUL_Nx5_5x6_FIRST4COLUMNS_ROW(0) MUL_Nx5_5x6_FIRST4COLUMNS_ROW(1)
                    MUL_Nx5_5x6_FIRST4COLUMNS_ROW(2) MUL_Nx5_5x6_FIRST4COLUMNS_ROW(3) MUL_Nx5_5x6_FIRST4COLUMNS_ROW(4)
                        MUL_Nx5_5x6_FIRST4COLUMNS_ROW(5) MUL_Nx5_5x6_LAST2COLUMNS_INIT MUL_Nx5_5x6_LAST2COLUMNS_ROW2(0)
                            MUL_Nx5_5x6_LAST2COLUMNS_ROW2(1) MUL_Nx5_5x6_LAST2COLUMNS_ROW2(2)
    ...
    case 6: {
        ...
        case 1: {
            if (!(l ^ 1))
            { // 1x6 * 6x1
                dstPtr[0] = m1Ptr[0] * m2Ptr[0] + m1Ptr[1] * m2Ptr[1] + m1Ptr[2] * m2Ptr[2] + m1Ptr[3] * m2Ptr[3] +
...
#define MUL_Nx6_6x2_INIT                                                                                               \
    __asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax,                                                           \
        dstPtr __asm movaps xmm0, [esi] __asm movaps xmm1, [esi + 16] __asm movaps xmm2, [esi + 32]

#define MUL_Nx6_6x2_ROW2(row)                                                                                          \
    __asm movaps xmm7, [edi + row * 48 + 0 * 4] __asm movaps xmm6, xmm7 __asm shufps xmm7, xmm7,                       \
        R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm7, xmm0 __asm shufps xmm6, xmm6,                                        \
        R_SHUFFLEPS(2, 2, 3, 3) __asm mulps xmm6, xmm1 __asm addps xmm7,                                               \
        xmm6 __asm movaps xmm6, [edi + row * 48 + 4 * 4] __asm movaps xmm5, xmm6 __asm shufps xmm6, xmm6,              \
        R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm6, xmm2 __asm addps xmm7, xmm6 __asm shufps xmm5, xmm5,                 \
        R_SHUFFLEPS(2, 2, 3, 3) __asm mulps xmm5,                                                                      \
        xmm0 __asm movaps xmm6, [edi + row * 48 + 24 + 2 * 4] __asm movaps xmm4, xmm6 __asm shufps xmm6, xmm6,         \
        R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm6, xmm1 __asm addps xmm5, xmm6 __asm shufps xmm4, xmm4,                 \
        R_SHUFFLEPS(2, 2, 3, 3) __asm mulps xmm4, xmm2 __asm addps xmm5, xmm4 __asm movaps xmm4,                       \
        xmm5 __asm movhlps xmm5, xmm7 __asm movlhps xmm7, xmm4 __asm addps xmm7, xmm5 __asm movaps[eax + row * 16],    \
        xmm7
...
#define MUL_Nx6_6x3_INIT                                                                                               \
    __asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax, dstPtr __asm movss xmm0, [esi + 0 * 4] __asm movhps xmm0, \
        [esi + 1 * 4] __asm movss xmm1, [esi + 3 * 4] __asm movhps xmm1, [esi + 4 * 4] __asm movss xmm2,               \
        [esi + 6 * 4] __asm movhps xmm2, [esi + 7 * 4] __asm movss xmm3, [esi + 9 * 4] __asm movhps xmm3,              \
        [esi + 10 * 4] __asm movss xmm4, [esi + 12 * 4] __asm movhps xmm4, [esi + 13 * 4] __asm movss xmm5,            \
        [esi + 15 * 4] __asm movhps xmm5, [esi + 16 * 4]

#define MUL_Nx6_6x3_ROW(row)                                                                                           \
    __asm movss xmm7, [edi + row * 24 + 0] __asm shufps xmm7, xmm7, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm7,          \
        xmm0 __asm movss xmm6, [edi + row * 24 + 4] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, \
        xmm1 __asm addps xmm7, xmm6 __asm movss xmm6, [edi + row * 24 + 8] __asm shufps xmm6, xmm6,                    \
        ...
        R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm5 __asm addps xmm7, xmm6 __asm movss[eax + row * 12 + 0],         \
        xmm7 __asm movhps[eax + row * 12 + 4], xmm7

                MUL_Nx6_6x3_INIT MUL_Nx6_6x3_ROW(0) MUL_Nx6_6x3_ROW(1) MUL_Nx6_6x3_ROW(2)
...
#define MUL_Nx6_6x4_INIT                                                                                               \
    __asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax,                                                           \
        dstPtr __asm movaps xmm0, [esi] __asm movaps xmm1, [esi + 16] __asm movaps xmm2, [esi + 32] __asm movaps xmm3, \
...
#define MUL_Nx6_6x4_ROW(row)                                                                                           \
    __asm movss xmm7, [edi + row * 24 + 0] __asm shufps xmm7, xmm7, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm7,          \
        ...
        R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm4 __asm addps xmm7,                                               \
        xmm6 __asm movss xmm6, [edi + row * 24 + 20] __asm shufps xmm6, xmm6,                                          \
        R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm5 __asm addps xmm7, xmm6 __asm movaps[eax + row * 16], xmm7

                MUL_Nx6_6x4_INIT MUL_Nx6_6x4_ROW(0) MUL_Nx6_6x4_ROW(1) MUL_Nx6_6x4_ROW(2) MUL_Nx6_6x4_ROW(3)
...
#define MUL_Nx6_6x5_INIT                                                                                               \
    __asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax,                                                           \
        dstPtr __asm movaps xmm0, [esi] __asm movlps xmm1, [esi + 20] __asm movhps xmm1, [esi + 28] __asm movlps xmm2, \
        [esi + 40] __asm movhps xmm2, [esi + 48] __asm movlps xmm3, [esi + 60] __asm movhps xmm3,                      \
        [esi + 68] __asm movaps xmm4, [esi + 80] __asm movlps xmm5, [esi + 100] __asm movhps xmm5, [esi + 108]

#define MUL_Nx6_6x5_ROW(row)                                                                                           \
    __asm movss xmm7, [edi + row * 24 + 0] __asm shufps xmm7, xmm7, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm7,          \
        xmm0 __asm fld dword ptr[edi + (row * 6 + 0) * 4] __asm fmul dword ptr[esi +                                   \
                                                                               (4 + 0 * 5) * 4] __asm movss xmm6,      \
        [edi + row * 24 + 4] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm1 __asm addps xmm7, \
        xmm6 __asm fld dword ptr[edi + (row * 6 + 1) * 4] __asm fmul dword ptr[esi +                                   \
                                                                               (4 + 1 * 5) * 4] __asm faddp st(1),     \
        st __asm movss xmm6, [edi + row * 24 + 8] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6,   \
        xmm2 __asm addps xmm7,                                                                                         \
        xmm6 __asm fld dword ptr[edi + (row * 6 + 2) * 4] __asm fmul dword ptr[esi +                                   \
                                                                               (4 + 2 * 5) * 4] __asm faddp st(1),     \
        st __asm movss xmm6, [edi + row * 24 + 12] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6,  \
        xmm3 __asm addps xmm7,                                                                                         \
        xmm6 __asm fld dword ptr[edi + (row * 6 + 3) * 4] __asm fmul dword ptr[esi +                                   \
                                                                               (4 + 3 * 5) * 4] __asm faddp st(1),     \
        st __asm movss xmm6, [edi + row * 24 + 16] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6,  \
        xmm4 __asm addps xmm7,                                                                                         \
        xmm6 __asm fld dword ptr[edi + (row * 6 + 4) * 4] __asm fmul dword ptr[esi +                                   \
                                                                               (4 + 4 * 5) * 4] __asm faddp st(1),     \
        st __asm movss xmm6, [edi + row * 24 + 20] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6,  \
        xmm5 __asm addps xmm7,                                                                                         \
        xmm6 __asm fld dword ptr[edi + (row * 6 + 5) * 4] __asm fmul dword ptr[esi +                                   \
                                                                               (4 + 5 * 5) * 4] __asm faddp st(1),     \
        st __asm fstp dword ptr[eax + (row * 5 + 4) * 4] __asm movlps[eax + row * 20],                                 \
        xmm7 __asm movhps[eax + row * 20 + 8], xmm7

                MUL_Nx6_6x5_INIT MUL_Nx6_6x5_ROW(0) MUL_Nx6_6x5_ROW(1) MUL_Nx6_6x5_ROW(2) MUL_Nx6_6x5_ROW(3)
                    MUL_Nx6_6x5_ROW(4)
        ...
        case 6: {
            ...
            case 2: { // 6x6 * 6x2
                ...
                MUL_Nx6_6x2_INIT MUL_Nx6_6x2_ROW2(0) MUL_Nx6_6x2_ROW2(1) MUL_Nx6_6x2_ROW2(2)

                    return;
            }
            case 3: { // 6x6 * 6x3

                MUL_Nx6_6x3_INIT MUL_Nx6_6x3_ROW(0) MUL_Nx6_6x3_ROW(1) MUL_Nx6_6x3_ROW(2) MUL_Nx6_6x3_ROW(3)
                    MUL_Nx6_6x3_ROW(4) MUL_Nx6_6x3_ROW(5)
            ...
            case 4: { // 6x6 * 6x4
                ...
                MUL_Nx6_6x4_INIT MUL_Nx6_6x4_ROW(0) MUL_Nx6_6x4_ROW(1) MUL_Nx6_6x4_ROW(2) MUL_Nx6_6x4_ROW(3)
                    MUL_Nx6_6x4_ROW(4) MUL_Nx6_6x4_ROW(5)
            ...
            case 5: { // 6x6 * 6x5
                ...
                MUL_Nx6_6x5_INIT MUL_Nx6_6x5_ROW(0) MUL_Nx6_6x5_ROW(1) MUL_Nx6_6x5_ROW(2) MUL_Nx6_6x5_ROW(3)
                    MUL_Nx6_6x5_ROW(4) MUL_Nx6_6x5_ROW(5)
...
#define MUL_2xN_2x2_INIT                                                                                               \
    __asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax, dstPtr __asm movlps xmm0, [esi] __asm shufps xmm0, xmm0,  \
        R_SHUFFLEPS(0, 1, 0, 1) __asm movlps xmm1, [esi + 8] __asm shufps xmm1, xmm1, R_SHUFFLEPS(0, 1, 0, 1)

#define MUL_2xN_2x2_ROW2(N, row)                                                                                       \
    __asm movlps xmm6, [edi + (row + 0 * N) * 4] __asm shufps xmm6, xmm6,                                              \
        R_SHUFFLEPS(0, 0, 1, 1) __asm movlps xmm7, [edi + (row + 1 * N) * 4] __asm shufps xmm7, xmm7,                  \
        R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm6, xmm0 __asm mulps xmm7, xmm1 __asm addps xmm6,                        \
        xmm7 __asm movaps[eax + (row * 2) * 4], xmm6

            MUL_2xN_2x2_INIT MUL_2xN_2x2_ROW2(6, 0) MUL_2xN_2x2_ROW2(6, 2) MUL_2xN_2x2_ROW2(6, 4)
...
#define MUL_3xN_3x3_INIT                                                                                               \
    __asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax,                                                           \
        dstPtr __asm movss xmm0, [esi + (0 * 3 + 0) * 4] __asm movhps xmm0, [esi + (0 * 3 + 1) * 4] __asm movss xmm1,  \
        [esi + (1 * 3 + 0) * 4] __asm movhps xmm1, [esi + (1 * 3 + 1) * 4] __asm movss xmm2,                           \
...
#define MUL_3xN_3x3_ROW4(N, row)                                                                                       \
    __asm movlps xmm3, [edi + (row + 0 * N + 0) * 4] __asm shufps xmm3, xmm3,                                          \
        R_SHUFFLEPS(0, 0, 0, 1) __asm movlps xmm4, [edi + (row + 1 * N + 0) * 4] __asm shufps xmm4, xmm4,              \
        R_SHUFFLEPS(0, 0, 0, 1) __asm movlps xmm5, [edi + (row + 2 * N + 0) * 4] __asm shufps xmm5, xmm5,              \
        R_SHUFFLEPS(0, 0, 0, 1) __asm mulps xmm3, xmm0 __asm mulps xmm4, xmm1 __asm mulps xmm5, xmm2 __asm addps xmm3, \
        xmm4 __asm addps xmm3, xmm5 __asm movaps[eax + (row * 3 + 0) * 4], xmm3 __asm shufps xmm0, xmm0,               \
        R_SHUFFLEPS(1, 2, 3, 1) __asm shufps xmm1, xmm1, R_SHUFFLEPS(1, 2, 3, 1) __asm shufps xmm2, xmm2,              \
        R_SHUFFLEPS(1, 2, 3, 1) __asm movlps xmm3, [edi + (row + 0 * N + 1) * 4] __asm shufps xmm3, xmm3,              \
        R_SHUFFLEPS(0, 0, 1, 1) __asm movlps xmm4, [edi + (row + 1 * N + 1) * 4] __asm shufps xmm4, xmm4,              \
        R_SHUFFLEPS(0, 0, 1, 1) __asm movlps xmm5, [edi + (row + 2 * N + 1) * 4] __asm shufps xmm5, xmm5,              \
        R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm3, xmm0 __asm mulps xmm4, xmm1 __asm mulps xmm5, xmm2 __asm addps xmm3, \
        xmm4 __asm addps xmm3, xmm5 __asm movaps[eax + (row * 3 + 4) * 4], xmm3 __asm shufps xmm0, xmm0,               \
        R_SHUFFLEPS(1, 2, 3, 1) __asm shufps xmm1, xmm1, R_SHUFFLEPS(1, 2, 3, 1) __asm shufps xmm2, xmm2,              \
        R_SHUFFLEPS(1, 2, 3, 1) __asm movlps xmm3, [edi + (row + 0 * N + 2) * 4] __asm shufps xmm3, xmm3,              \
        R_SHUFFLEPS(0, 1, 1, 1) __asm movlps xmm4, [edi + (row + 1 * N + 2) * 4] __asm shufps xmm4, xmm4,              \
        R_SHUFFLEPS(0, 1, 1, 1) __asm movlps xmm5, [edi + (row + 2 * N + 2) * 4] __asm shufps xmm5, xmm5,              \
        R_SHUFFLEPS(0, 1, 1, 1) __asm mulps xmm3, xmm0 __asm mulps xmm4, xmm1 __asm mulps xmm5, xmm2 __asm addps xmm3, \
        xmm4 __asm addps xmm3, xmm5 __asm movaps[eax + (row * 3 + 8) * 4], xmm3
...
#define MUL_3xN_3x3_ROW(N, row)                                                                                        \
    __asm movss xmm3, [edi + (row + 0 * N) * 4] __asm shufps xmm3, xmm3,                                               \
        R_SHUFFLEPS(0, 0, 0, 0) __asm movss xmm4, [edi + (row + 1 * N) * 4] __asm shufps xmm4, xmm4,                   \
        R_SHUFFLEPS(0, 0, 0, 0) __asm movss xmm5, [edi + (row + 2 * N) * 4] __asm shufps xmm5, xmm5,                   \
        R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm3, xmm0 __asm mulps xmm4, xmm1 __asm mulps xmm5, xmm2 __asm addps xmm3, \
        xmm4 __asm addps xmm3, xmm5 __asm movss[eax + (row * 3 + 0) * 4], xmm3 __asm movhps[eax + (row * 3 + 1) * 4],  \
        xmm3

            MUL_3xN_3x3_INIT MUL_3xN_3x3_INIT_ROW4 MUL_3xN_3x3_ROW4(6, 0)
                MUL_3xN_3x3_INIT_ROW4_ROW MUL_3xN_3x3_ROW(6, 4) MUL_3xN_3x3_ROW(6, 5)
...
#define MUL_4xN_4x4_INIT                                                                                               \
    __asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax, dstPtr __asm movaps xmm0, [esi] __asm movaps xmm1,        \
        [esi + 16] __asm movaps xmm2, [esi + 32] __asm movaps xmm3, [esi + 48]

#define MUL_4xN_4x4_ROW(N, row)                                                                                        \
    __asm movss xmm7, [edi + (row + 0 * N) * 4] __asm shufps xmm7, xmm7, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm7,     \
        xmm0 __asm movss xmm6, [edi + (row + 1 * N) * 4] __asm shufps xmm6, xmm6,                                      \
        R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm1 __asm addps xmm7,                                               \
        xmm6 __asm movss xmm6, [edi + (row + 2 * N) * 4] __asm shufps xmm6, xmm6,                                      \
        R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm2 __asm addps xmm7,                                               \
        xmm6 __asm movss xmm6, [edi + (row + 3 * N) * 4] __asm shufps xmm6, xmm6,                                      \
        R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm3 __asm addps xmm7, xmm6 __asm movaps[eax + row * 16], xmm7

            MUL_4xN_4x4_INIT MUL_4xN_4x4_ROW(6, 0) MUL_4xN_4x4_ROW(6, 1) MUL_4xN_4x4_ROW(6, 2) MUL_4xN_4x4_ROW(6, 3)
                MUL_4xN_4x4_ROW(6, 4) MUL_4xN_4x4_ROW(6, 5)
...
#define MUL_5xN_5x5_INIT                                                                                               \
    __asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax,                                                           \
        dstPtr __asm movlps xmm0, [esi + 0 * 4] __asm movhps xmm0, [esi + 2 * 4] __asm movlps xmm1,                    \
        [esi + 5 * 4] __asm movhps xmm1, [esi + 7 * 4] __asm movlps xmm2, [esi + 10 * 4] __asm movhps xmm2,            \
        [esi + 12 * 4] __asm movlps xmm3, [esi + 15 * 4] __asm movhps xmm3, [esi + 17 * 4] __asm movlps xmm4,          \
        [esi + 20 * 4] __asm movhps xmm4, [esi + 22 * 4]

#define MUL_5xN_5x5_ROW(N, row)                                                                                        \
    __asm movss xmm6, [edi + (row + 0 * N) * 4] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6,     \
        xmm0 __asm fld dword ptr[edi + (row + 0 * N) * 4] __asm fmul dword ptr[esi + 4 * 4] __asm movss xmm5,          \
        [edi + (row + 1 * N) * 4] __asm shufps xmm5, xmm5, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm5,                   \
        xmm1 __asm addps xmm6,                                                                                         \
        xmm5 __asm fld dword ptr[edi + (row + 1 * N) * 4] __asm fmul dword ptr[esi + 9 * 4] __asm faddp st(1),         \
        st __asm movss xmm5, [edi + (row + 2 * N) * 4] __asm shufps xmm5, xmm5,                                        \
        R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm5, xmm2 __asm addps xmm6,                                               \
        xmm5 __asm fld dword ptr[edi + (row + 2 * N) * 4] __asm fmul dword ptr[esi + 14 * 4] __asm faddp st(1),        \
        st __asm movss xmm5, [edi + (row + 3 * N) * 4] __asm shufps xmm5, xmm5,                                        \
        R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm5, xmm3 __asm addps xmm6,                                               \
        xmm5 __asm fld dword ptr[edi + (row + 3 * N) * 4] __asm fmul dword ptr[esi + 19 * 4] __asm faddp st(1),        \
        st __asm movss xmm5, [edi + (row + 4 * N) * 4] __asm shufps xmm5, xmm5,                                        \
        R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm5, xmm4 __asm addps xmm6,                                               \
        xmm5 __asm fld dword ptr[edi + (row + 4 * N) * 4] __asm fmul dword ptr[esi + 24 * 4] __asm faddp st(1),        \
        st __asm fstp dword ptr[eax + (row * 5 + 4) * 4] __asm movlps[eax + (row * 5 + 0) * 4],                        \
        xmm6 __asm movhps[eax + (row * 5 + 2) * 4], xmm6

            MUL_5xN_5x5_INIT MUL_5xN_5x5_ROW(6, 0) MUL_5xN_5x5_ROW(6, 1) MUL_5xN_5x5_ROW(6, 2) MUL_5xN_5x5_ROW(6, 3)
                MUL_5xN_5x5_ROW(6, 4) MUL_5xN_5x5_ROW(6, 5)
...
#define MUL_6xN_6x6_FIRST4COLUMNS_INIT                                                                                 \
    __asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax, dstPtr __asm movlps xmm0,                                 \
        [esi + 0 * 4] __asm movhps xmm0, [esi + 2 * 4] __asm movlps xmm1, [esi + 6 * 4] __asm movhps xmm1,             \
        [esi + 8 * 4] __asm movlps xmm2, [esi + 12 * 4] __asm movhps xmm2, [esi + 14 * 4] __asm movlps xmm3,           \
        [esi + 18 * 4] __asm movhps xmm3, [esi + 20 * 4] __asm movlps xmm4, [esi + 24 * 4] __asm movhps xmm4,          \
        [esi + 26 * 4] __asm movlps xmm5, [esi + 30 * 4] __asm movhps xmm5, [esi + 32 * 4]
...
#define MUL_6xN_6x6_FIRST4COLUMNS_ROW(N, row)                                                                          \
    __asm movss xmm7, [edi + (row + 0 * N) * 4] __asm shufps xmm7, xmm7, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm7,     \
        ...
        xmm6 __asm movss xmm6, [edi + (row + 3 * N) * 4] __asm shufps xmm6, xmm6,                                      \
        R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm3 __asm addps xmm7,                                               \
        xmm6 __asm movss xmm6, [edi + (row + 4 * N) * 4] __asm shufps xmm6, xmm6,                                      \
        R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm4 __asm addps xmm7,                                               \
        xmm6 __asm movss xmm6, [edi + (row + 5 * N) * 4] __asm shufps xmm6, xmm6,                                      \
        R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm5 __asm addps xmm7, xmm6 __asm movlps[eax + (row * 6 + 0) * 4],   \
        xmm7 __asm movhps[eax + (row * 6 + 2) * 4], xmm7

#define MUL_6xN_6x6_LAST2COLUMNS_INIT                                                                                  \
    __asm movlps xmm0, [esi + 4 * 4] __asm movlps xmm1, [esi + 10 * 4] __asm shufps xmm0, xmm0,                        \
        R_SHUFFLEPS(0, 1, 0, 1) __asm shufps xmm1, xmm1,                                                               \
        R_SHUFFLEPS(0, 1, 0, 1) __asm movlps xmm2, [esi + 16 * 4] __asm movlps xmm3, [esi + 22 * 4] __asm shufps xmm2, \
        xmm2, R_SHUFFLEPS(0, 1, 0, 1) __asm shufps xmm3, xmm3,                                                         \
        R_SHUFFLEPS(0, 1, 0, 1) __asm movlps xmm4, [esi + 28 * 4] __asm movlps xmm5, [esi + 34 * 4] __asm shufps xmm4, \
...
#define MUL_6xN_6x6_LAST2COLUMNS_ROW2(N, row)                                                                          \
    __asm movlps xmm7, [edi + (row * 2 + 0 * N) * 4] __asm shufps xmm7, xmm7,                                          \
        ...
        xmm0 __asm movlps xmm6, [edi + (row * 2 + 1 * N) * 4] __asm shufps xmm6, xmm6,                                 \
        R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm6, xmm1 __asm addps xmm7,                                               \
        xmm6 __asm movlps xmm6, [edi + (row * 2 + 2 * N) * 4] __asm shufps xmm6, xmm6,                                 \
        R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm6, xmm2 __asm addps xmm7,                                               \
        xmm6 __asm movlps xmm6, [edi + (row * 2 + 3 * N) * 4] __asm shufps xmm6, xmm6,                                 \
        R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm6, xmm3 __asm addps xmm7,                                               \
        xmm6 __asm movlps xmm6, [edi + (row * 2 + 4 * N) * 4] __asm shufps xmm6, xmm6,                                 \
        R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm6, xmm4 __asm addps xmm7,                                               \
        xmm6 __asm movlps xmm6, [edi + (row * 2 + 5 * N) * 4] __asm shufps xmm6, xmm6,                                 \
        R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm6, xmm5 __asm addps xmm7, xmm6 __asm movlps[eax + (row * 12 + 4) * 4],  \
        xmm7 __asm movhps[eax + (row * 12 + 10) * 4], xmm7

#define MUL_6xN_6x6_LAST2COLUMNS_ROW(N, row)                                                                           \
    __asm movss xmm7, [edi + (1 * N - 1) * 4] __asm shufps xmm7, xmm7, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm7,       \
        ...
        R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm5 __asm addps xmm7, xmm6 __asm movlps[eax + (row * 6 + 4) * 4],   \
        xmm7
            ...
            case 2: { // 6x2 * 6x6
                ...
                MUL_6xN_6x6_FIRST4COLUMNS_INIT MUL_6xN_6x6_FIRST4COLUMNS_ROW(2, 0) MUL_6xN_6x6_FIRST4COLUMNS_ROW(2, 1)
                    MUL_6xN_6x6_LAST2COLUMNS_INIT MUL_6xN_6x6_LAST2COLUMNS_ROW2(2, 0)

                        return;
            }
            case 3: { // 6x3 * 6x6

                MUL_6xN_6x6_FIRST4COLUMNS_INIT MUL_6xN_6x6_FIRST4COLUMNS_ROW(3, 0) MUL_6xN_6x6_FIRST4COLUMNS_ROW(3, 1)
                    MUL_6xN_6x6_FIRST4COLUMNS_ROW(3, 2)
                        MUL_6xN_6x6_LAST2COLUMNS_INIT MUL_6xN_6x6_LAST2COLUMNS_ROW2(3, 0)
            ...
            case 4: { // 6x4 * 6x6
                ...
                MUL_6xN_6x6_FIRST4COLUMNS_INIT MUL_6xN_6x6_FIRST4COLUMNS_ROW(4, 0) MUL_6xN_6x6_FIRST4COLUMNS_ROW(4, 1)
                    MUL_6xN_6x6_FIRST4COLUMNS_ROW(4, 2) MUL_6xN_6x6_FIRST4COLUMNS_ROW(4, 3)
                        MUL_6xN_6x6_LAST2COLUMNS_INIT MUL_6xN_6x6_LAST2COLUMNS_ROW2(4, 0)
            ...
            case 5: { // 6x5 * 6x6
                ...
                MUL_6xN_6x6_FIRST4COLUMNS_INIT MUL_6xN_6x6_FIRST4COLUMNS_ROW(5, 0) MUL_6xN_6x6_FIRST4COLUMNS_ROW(5, 1)
                    MUL_6xN_6x6_FIRST4COLUMNS_ROW(5, 2) MUL_6xN_6x6_FIRST4COLUMNS_ROW(5, 3)
                        MUL_6xN_6x6_FIRST4COLUMNS_ROW(5, 4)
                            MUL_6xN_6x6_LAST2COLUMNS_INIT MUL_6xN_6x6_LAST2COLUMNS_ROW2(5, 0)
                                MUL_6xN_6x6_LAST2COLUMNS_ROW2(5, 1) MUL_6xN_6x6_LAST2COLUMNS_ROW(5, 4)

                                    return;
            }
            case 6: { // 6x6 * 6x6

                MUL_6xN_6x6_FIRST4COLUMNS_INIT MUL_6xN_6x6_FIRST4COLUMNS_ROW(6, 0) MUL_6xN_6x6_FIRST4COLUMNS_ROW(6, 1)
                    MUL_6xN_6x6_FIRST4COLUMNS_ROW(6, 2) MUL_6xN_6x6_FIRST4COLUMNS_ROW(6, 3)
                        MUL_6xN_6x6_FIRST4COLUMNS_ROW(6, 4) MUL_6xN_6x6_FIRST4COLUMNS_ROW(6, 5)
                            MUL_6xN_6x6_LAST2COLUMNS_INIT MUL_6xN_6x6_LAST2COLUMNS_ROW2(6, 0)
                                MUL_6xN_6x6_LAST2COLUMNS_ROW2(6, 1) MUL_6xN_6x6_LAST2COLUMNS_ROW2(6, 2)
...
#define NSKIP(n, s) ((n << 3) | (s & 7))
        ...
        case NSKIP(5, 3):
            x[3] = b[3] - lptr[3 * nc + 0] * x[0] - lptr[3 * nc + 1] * x[1] - lptr[3 * nc + 2] * x[2];
        case NSKIP(5, 4):
            x[4] = b[4] - lptr[4 * nc + 0] * x[0] - lptr[4 * nc + 1] * x[1] - lptr[4 * nc + 2] * x[2] -
                   lptr[4 * nc + 3] * x[3];
            return;
        case NSKIP(6, 0):
            x[0] = b[0];
        ...
        case NSKIP(6, 4):
            x[4] = b[4] - lptr[4 * nc + 0] * x[0] - lptr[4 * nc + 1] * x[1] - lptr[4 * nc + 2] * x[2] -
                   lptr[4 * nc + 3] * x[3];
        case NSKIP(6, 5):
            x[5] = b[5] - lptr[5 * nc + 0] * x[0] - lptr[5 * nc + 1] * x[1] - lptr[5 * nc + 2] * x[2] -
                   lptr[5 * nc + 3] * x[3] - lptr[5 * nc + 4] * x[4];
            return;
        case NSKIP(7, 0):
            x[0] = b[0];
        case NSKIP(7, 1):
        ...
        case NSKIP(7, 5):
            x[5] = b[5] - lptr[5 * nc + 0] * x[0] - lptr[5 * nc + 1] * x[1] - lptr[5 * nc + 2] * x[2] -
                   lptr[5 * nc + 3] * x[3] - lptr[5 * nc + 4] * x[4];
        case NSKIP(7, 6):
            x[6] = b[6] - lptr[6 * nc + 0] * x[0] - lptr[6 * nc + 1] * x[1] - lptr[6 * nc + 2] * x[2] -
                   lptr[6 * nc + 3] * x[3] - lptr[6 * nc + 4] * x[4] - lptr[6 * nc + 5] * x[5];
            return;
        }
        return;
    }
...
void VPCALL idSIMD_SSE::MatX_LowerTriangularSolveTranspose(const idMatX &L, float *x, const float *b, const int n)
{
    ...
    if (n < 8)
    {
        ...
        case 5:
            ...
            x[0] = b[0] - lptr[4 * nc + 0] * x[4] - lptr[3 * nc + 0] * x[3] - lptr[2 * nc + 0] * x[2] -
                   lptr[1 * nc + 0] * x[1];
            return;
        case 6:
            x[5] = b[5];
            ...
            x[1] = b[1] - lptr[5 * nc + 1] * x[5] - lptr[4 * nc + 1] * x[4] - lptr[3 * nc + 1] * x[3] -
                   lptr[2 * nc + 1] * x[2];
            x[0] = b[0] - lptr[5 * nc + 0] * x[5] - lptr[4 * nc + 0] * x[4] - lptr[3 * nc + 0] * x[3] -
        ...
        case 7:
            ...
            x[2] = b[2] - lptr[6 * nc + 2] * x[6] - lptr[5 * nc + 2] * x[5] - lptr[4 * nc + 2] * x[4] -
                   lptr[3 * nc + 2] * x[3];
            x[1] = b[1] - lptr[6 * nc + 1] * x[6] - lptr[5 * nc + 1] * x[5] - lptr[4 * nc + 1] * x[4] -
                   lptr[3 * nc + 1] * x[3] - lptr[2 * nc + 1] * x[2];
            x[0] = b[0] - lptr[6 * nc + 0] * x[6] - lptr[5 * nc + 0] * x[5] - lptr[4 * nc + 0] * x[4] -
                   lptr[3 * nc + 0] * x[3] - lptr[2 * nc + 0] * x[2] - lptr[1 * nc + 0] * x[1];
            return;
        }
        return;
    }
...
============
*/
void VPCALL idSIMD_SSE::TransformVerts(idDrawVert *verts, const int numVerts, const idJointMat *joints,
...
============
*/
void VPCALL idSIMD_SSE::TracePointCull(byte *cullBits, byte &totalOr, const float radius, const idPlane *planes,
...
============
*/
void VPCALL idSIMD_SSE::DecalPointCull(byte *cullBits, const idPlane *planes, const idDrawVert *verts,
                                       const int numVerts)
{
#if 1
...
============
*/
void VPCALL idSIMD_SSE::OverlayPointCull(byte *cullBits, idVec2 *texCoords, const idPlane *planes,
                                         const idDrawVert *verts, const int numVerts)
{
#if 1
...
============
*/
void VPCALL idSIMD_SSE::DeriveTriPlanes(idPlane *planes, const idDrawVert *verts, const int numVerts,
...
void VPCALL idSIMD_SSE::DeriveTangents(idPlane *planes, idDrawVert *verts, const int numVerts, const int *indexes,
...
void VPCALL idSIMD_SSE::DeriveUnsmoothedTangents(idDrawVert *verts, const dominantTri_s *dominantTris,
                                                 const int numVerts)
{
    int i, j;
...
============
*/
void VPCALL idSIMD_SSE::CreateTextureSpaceLightVectors(idVec3 *lightVectors, const idVec3 &lightOrigin,
                                                       const idDrawVert *verts, const int numVerts, const int *indexes,
                                                       const int numIndexes)
{
    ...
    for (int i = 0; i < numVerts; i++)
    {
        ...
        lightVectors[i][0] =
            lightDir[0] * v->tangents[0][0] + lightDir[1] * v->tangents[0][1] + lightDir[2] * v->tangents[0][2];
        lightVectors[i][1] =
            lightDir[0] * v->tangents[1][0] + lightDir[1] * v->tangents[1][1] + lightDir[2] * v->tangents[1][2];
...
============
*/
void VPCALL idSIMD_SSE::CreateSpecularTextureCoords(idVec4 *texCoords, const idVec3 &lightOrigin,
                                                    const idVec3 &viewOrigin, const idDrawVert *verts,
                                                    const int numVerts, const int *indexes, const int numIndexes)
{
...
============
*/
int VPCALL idSIMD_SSE::CreateShadowCache(idVec4 *vertexCache, int *vertRemap, const idVec3 &lightOrigin,
                                         const idDrawVert *verts, const int numVerts)
{
#if 1
    int outVerts;
...
============
*/
void idSIMD_SSE::UpSamplePCMTo44kHz(float *dest, const short *src, const int numSamples, const int kHz,
...
============
*/
void VPCALL idSIMD_SSE::MixSoundTwoSpeakerMono(float *mixBuffer, const float *samples, const int numSamples,
...
============
*/
void VPCALL idSIMD_SSE::MixSoundTwoSpeakerStereo(float *mixBuffer, const float *samples, const int numSamples,
                                                 const float lastV[2], const float currentV[2])
{
#if 1
...
============
*/
void VPCALL idSIMD_SSE::MixSoundSixSpeakerMono(float *mixBuffer, const float *samples, const int numSamples,
                                               const float lastV[6], const float currentV[6])
{
#if 1
...
============
*/
void VPCALL idSIMD_SSE::MixSoundSixSpeakerStereo(float *mixBuffer, const float *samples, const int numSamples,
                                                 const float lastV[6], const float currentV[6])
{
#if 1
