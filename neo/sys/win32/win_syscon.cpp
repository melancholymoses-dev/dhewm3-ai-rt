...
LONG WINAPI InputLineWndProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CHAR:
        ...
        if ((key >= K_SPACE && key <= K_BACKSPACE) || (key >= K_KP_SLASH && key <= K_KP_PLUS) ||
...
void Sys_CreateConsole(void)
{
    ...
    s_wcd.hWnd =
        CreateWindowEx(0, DEDCLASS, GAME_NAME, DEDSTYLE, (swidth - 600) / 2, (sheight - 450) / 2,
                       rect.right - rect.left + 1, rect.bottom - rect.top + 1, NULL, NULL, win32.hInstance, NULL);
    ...
    s_wcd.hfBufferFont = CreateFont(nHeight, 0, 0, 0, FW_LIGHT, 0, 0, 0, DEFAULT_CHARSET, OUT_DEFAULT_PRECIS,
    ...
    //
    s_wcd.hwndInputLine = CreateWindow("edit", NULL, WS_CHILD | WS_VISIBLE | WS_BORDER | ES_LEFT | ES_AUTOHSCROLL, 6,
                                       400, 528, 20, s_wcd.hWnd,
    ...
    // create the buttons
    //
    s_wcd.hwndButtonCopy = CreateWindow("button", NULL, BS_PUSHBUTTON | WS_VISIBLE | WS_CHILD | BS_DEFPUSHBUTTON, 5,
                                        425, 72, 24, s_wcd.hWnd,
                                        (HMENU)COPY_ID, // child window ID
                                        win32.hInstance, NULL);
    SendMessage(s_wcd.hwndButtonCopy, WM_SETTEXT, 0, (LPARAM) "copy");

    s_wcd.hwndButtonClear = CreateWindow("button", NULL, BS_PUSHBUTTON | WS_VISIBLE | WS_CHILD | BS_DEFPUSHBUTTON, 82,
                                         425, 72, 24, s_wcd.hWnd,
                                         (HMENU)CLEAR_ID, // child window ID
                                         win32.hInstance, NULL);
    SendMessage(s_wcd.hwndButtonClear, WM_SETTEXT, 0, (LPARAM) "clear");

    s_wcd.hwndButtonQuit = CreateWindow("button", NULL, BS_PUSHBUTTON | WS_VISIBLE | WS_CHILD | BS_DEFPUSHBUTTON, 462,
                                        425, 72, 24, s_wcd.hWnd,
    ...
    //
    s_wcd.hwndBuffer = CreateWindow("edit", NULL,
    ...
    s_wcd.SysInputLineWndProc =
        (LONG_PTR)SetWindowLongPtr(s_wcd.hwndInputLine, GWLP_WNDPROC, (LONG_PTR)InputLineWndProc);
