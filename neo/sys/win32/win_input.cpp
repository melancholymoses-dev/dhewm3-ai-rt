...
// DG: at least MinGW doesn't like the old scantokey tables, seems to be some
// kind of charcode-fuckup
//     (no -finput-charset=ISO8859-1 doesn't seem to help, see #238) - so use
