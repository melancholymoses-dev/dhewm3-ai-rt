...
//  [X] Platform: Clipboard support is part of core Dear ImGui (no specific code
//  in this backend). [X] Platform: Mouse support. Can discriminate Mouse/Pen.
...
//  ImGui::IsKeyPressed(ImGuiKey_Space). [Legacy kVK_* values are obsolete
//  since 1.87 and not supported since 1.91.5] [X] Platform: Gamepad support.
//  Enabled with 'io.ConfigFlags |= ImGuiConfigFlags_NavEnableGamepad'. [X]
