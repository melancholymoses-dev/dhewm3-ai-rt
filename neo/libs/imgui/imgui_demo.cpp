...
#pragma GCC diagnostic ignored "-Wconversion"          // warning: conversion to 'xxxx' from 'xxxx' may alter its
                                                       // value
#pragma GCC diagnostic ignored "-Wmisleading-indentation" // [__GNUC__ >= 6] warning: this 'if' clause does
...
struct ExampleSelectionWithDeletion : ImGuiSelectionBasicStorage
{
    ...
    int ApplyDeletionPreLoop(ImGuiMultiSelectIO *ms_io, int items_count)
    {
        ...
        {
            ms_io->RangeSrcReset = true; // Request to recover RangeSrc from NavId next frame. Would be
...
static void ShowDemoWindowMultiSelect(ImGuiDemoWindowData *demo_data)
{
    ...
    {
        HelpMarker("Selections can be built using Selectable(), TreeNode() or other "
        ...
        {
            HelpMarker("This is rather advanced and experimental. If you are getting "
            ...
            struct ExampleTreeFuncs
            {
                static void DrawNode(ExampleTreeNode *node, ImGuiSelectionBasicStorage *selection)
                {
                    ImGuiTreeNodeFlags tree_node_flags = ImGuiTreeNodeFlags_SpanAvailWidth |
                                                         ...
                                                         ImGuiTreeNodeFlags_OpenOnDoubleClick;
                    tree_node_flags |= ImGuiTreeNodeFlags_NavLeftJumpsBackHere; // Enable pressing left
                                                                                // to jump to parent
        ...
        if (ImGui::TreeNode("Multi-Select (advanced)"))
        {
            ...
            if (ImGui::TreeNode("Options"))
            {
                ...
                ImGui::SameLine();
                HelpMarker("TreeNode() is technically supported but... using this correctly "
...
static void EditTableSizingFlags(ImGuiTableFlags *p_flags)
{
    ...
    static const EnumDesc policies[] = {{ImGuiTableFlags_None, "Default",
        ...
        if (ImGui::BeginTable("3ways", 3, table_flags))
        {
            ...
            struct MyTreeNode
            {
                ...
                static void DisplayNode(const MyTreeNode *node, const MyTreeNode *all_nodes)
                {
                    ...
                    if (node != &all_nodes[0])
                        node_flags &= ~ImGuiTreeNodeFlags_LabelSpanAllColumns; // Only demonstrate
                                                                               // this on the root
                                                                               // node.
        ...
        if (ImGui::TreeNode("Options"))
        {
            ...
            if (ImGui::TreeNodeEx("Headers:", ImGuiTreeNodeFlags_DefaultOpen))
            {
                ...
                ImGui::CheckboxFlags("ImGuiTableColumnFlags_AngledHeader", &columns_base_flags,
                                     ImGuiTableColumnFlags_AngledHeader);
                ImGui::SameLine();
                HelpMarker("Enable AngledHeader on all columns. Best enabled on selected "
...
void ImGui::ShowStyleEditor(ImGuiStyle *ref)
{
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        if (ImGui::BeginTabItem("Sizes"))
        {
            ...
            ImGui::SameLine();
            HelpMarker("Apply to every windows, menus, popups, tooltips: amount where we "
...
struct ExampleAppPropertyEditor
{
    ...
    void DrawTreeNode(ExampleTreeNode *node)
    {
        ...
        tree_flags |= ImGuiTreeNodeFlags_OpenOnArrow | ImGuiTreeNodeFlags_OpenOnDoubleClick; // Standard opening mode as
...
struct ExampleAssetsBrowser
{
    ...
    ExampleSelectionWithDeletion Selection; // Our selection (ImGuiSelectionBasicStorage + helper funcs to
                                            // handle deletion)
