 ...
 * stdio for file I/O. */
#define MINIZ_NO_STDIO // DG: don't need STDIO here, miniZ*IP* does the I/O,
                       // mini*Z* is just for deflate
...
#define MINIZ_NO_ARCHIVE_APIS // DG: don't need this either, using minizip for
                              // zips
...
#define TDEFL_LESS_MEMORY 0
    ...
    MINIZ_EXPORT void *tdefl_compress_mem_to_heap(const void *pSrc_buf, size_t src_buf_len, size_t *pOut_len,
                                                  int flags);
...
extern "C"
{
     ...
     * needed. */
    MINIZ_EXPORT void *tinfl_decompress_mem_to_heap(const void *pSrc_buf, size_t src_buf_len, size_t *pOut_len,
                                                    int flags);
...
extern "C"
{
    ...
    MINIZ_EXPORT mz_bool mz_zip_reader_extract_file_to_mem_no_alloc(mz_zip_archive *pZip, const char *pFilename,
