...
int idBrushBSP::BrushSplitterStats(const idBrush *brush, int planeNum, const idPlaneSet &planeList, bool *testedPlanes,
...
============
*/
int idBrushBSP::FindSplitter(idBrushBSPNode *node, const idPlaneSet &planeList, bool *testedPlanes,
                             struct splitterStats_s &bestStats)
{
    ...
    for (brush = node->brushList.Head(); brush; brush = brush->Next())
    {
        ...
        for (i = 0; i < brush->GetNumSides(); i++)
        {
            ...
            value = f * stats.numFacing - 10 * stats.numSplits - abs(stats.numFront - stats.numBack) -
...
============
*/
idBrushBSPNode *idBrushBSP::BuildBrushBSP_r(idBrushBSPNode *node, const idPlaneSet &planeList, bool *testedPlanes,
                                            int skipContents)
{
    int planeNum;
...
============
*/
void idBrushBSP::Build(idBrushList brushList, int skipContents, bool (*ChopAllowed)(idBrush *b1, idBrush *b2),
...
============
*/
void idBrushBSP::UpdateTreeAfterMerge_r(idBrushBSPNode *node, const idBounds &bounds, idBrushBSPNode *oldNode,
