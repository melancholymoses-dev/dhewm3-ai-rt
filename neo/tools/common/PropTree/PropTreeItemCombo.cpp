...
CPropTreeItemCombo::CPropTreeItemCombo() : m_lComboData(0), m_nDropHeight(DROPDOWN_HEIGHT)
{
}
...
void CPropTreeItemCombo::OnActivate(int activateType, CPoint point)
{
    ...
    SetWindowPos(NULL, m_rc.left, m_rc.top, m_rc.Width() + 1, m_rc.Height() + m_nDropHeight,
