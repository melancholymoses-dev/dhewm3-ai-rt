...
const char *CDialogTextures::TypeNames[] = {"None",   "Textures",    "Materials", "Models",    "Scripts",
...
// =======================================================================================================================
//
CDialogTextures::CDialogTextures(CWnd *pParent /* =NULL */) : CDialog(CDialogTextures::IDD, pParent)
{
    setTexture = true;
...
void CDialogTextures::OnSize(UINT nType, int cx, int cy)
{
    ...
    m_treeTextures.SetWindowPos(NULL, rect.left + s4, rect.top + s8 + rect2.Height(), (rect.Width() - s8),
                                verticalSpace, SWP_SHOWWINDOW);
    m_wndPreview.SetWindowPos(NULL, rect.left + s4, rect.top + s12 + rect2.Height() + verticalSpace,
                              (rect.Width() - s8), verticalSpace, SWP_SHOWWINDOW);
