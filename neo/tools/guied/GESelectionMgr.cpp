...
rvGESelectionMgr::EHitTest rvGESelectionMgr::HitTest(float x, float y)
{
    ...
    if (idRectangle(mRect.x - GUIED_GRABSIZE, mRect.y + mRect.h / 2 - GUIED_GRABSIZE / 2, GUIED_GRABSIZE,
                    GUIED_GRABSIZE)
            .Contains(x, y))
    {
        return HT_SIZE_LEFT;
    ...
    if (idRectangle(mRect.x + mRect.w / 2 - GUIED_GRABSIZE / 2, mRect.y + mRect.h, GUIED_GRABSIZE, GUIED_GRABSIZE)
            .Contains(x, y))
    {
    ...
    if (idRectangle(mRect.x + mRect.w, mRect.y + mRect.h / 2 - GUIED_GRABSIZE / 2, GUIED_GRABSIZE, GUIED_GRABSIZE)
            .Contains(x, y))
    {
    ...
    if (idRectangle(mRect.x + mRect.w / 2 - GUIED_GRABSIZE / 2, mRect.y - GUIED_GRABSIZE, GUIED_GRABSIZE,
                    GUIED_GRABSIZE)
            .Contains(x, y))
    {
        return HT_SIZE_TOP;
