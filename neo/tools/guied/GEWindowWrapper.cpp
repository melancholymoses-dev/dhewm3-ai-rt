...
void rvGEWindowWrapper::SetRect(idRectangle &rect)
{
    ...
    s = va("%d,%d,%d,%d", (int)(rect.x + 0.5f), (int)(rect.y + 0.5f), (int)((rect.w + 0.5f) * (mFlippedHorz ? -1 : 1)),
...
{
    static const char *typeNames[] = {"Unknown",   "windowDef", "editDef", "htmlDef",  "choiceDef",
                                      "sliderDef", "bindDef",   "listDef", "renderDef"};
...
bool rvGEWindowWrapper::VerfiyStateKey(const char *name, const char *value, idStr *result)
{
    ...
    idParser src(value, strlen(value), "",
                 LEXFL_NOSTRINGCONCAT | LEXFL_ALLOWMULTICHARLITERALS | LEXFL_ALLOWBACKSLASHSTRINGCONCAT);
