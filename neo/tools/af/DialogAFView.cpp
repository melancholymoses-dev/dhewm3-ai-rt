...
toolTip_t DialogAFView::toolTips[] = {
    ...
    {IDC_CHECK_VIEW_CONSTRAINEDBODIES, "show bodies constrained by current constraint (body1 = cyan, body2 = "
                                       "blue)"},
...
================
*/
DialogAFView::DialogAFView(CWnd *pParent /*=NULL*/) : CDialog(DialogAFView::IDD, pParent)
