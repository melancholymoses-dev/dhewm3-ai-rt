...
CDialogPDAEditor::CDialogPDAEditor(CWnd *pParent /*=NULL*/) : CDialog(CDialogPDAEditor::IDD, pParent)
{
...
void CDialogPDAEditor::OnBtnClickedEmailAdd()
{
    ...
    if (pda)
    {
        ...
        {
            idDeclEmail *email =
                static_cast<idDeclEmail *>(declManager->CreateNewDecl(DECL_EMAIL, name, pda->GetFileName()));
...
CDialogPDAEditEmail::CDialogPDAEditEmail(CWnd *pParent /*=NULL*/) : CDialog(CDialogPDAEditEmail::IDD, pParent)
{
