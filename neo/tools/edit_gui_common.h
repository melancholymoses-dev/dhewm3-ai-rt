// header that includes all the other needed headers, replacement for
// precompiled.h (only used by tools)
...
//   MBCS support in MFC is deprecated and may be removed in a future version of
//   MFC."
...
// scaling factor based on DPI (dpi/96.0f, so 1.0 by default); implemented in
// win_main.cpp
