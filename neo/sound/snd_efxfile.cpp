...
#define mB_to_gain(millibels, property) _mB_to_gain(millibels, AL_EAXREVERB_MIN_##property, AL_EAXREVERB_MAX_##property)
...
bool idEFXFile::ReadEffect(idLexer &src, idSoundEffect *effect)
{
    ...
    do
    {
        ...
        {
            // <+KittyCat> the "environment" token should be ignored (efx has nothing
            // equatable to it)
            src.ParseInt();
        }
