...
class idCollisionModelManager
{
  public:
    ...
    virtual void Translation(trace_t *results, const idVec3 &start, const idVec3 &end, const idTraceModel *trm,
    ...
    virtual bool WriteCollisionModelForMapEntity(const idMapEntity *mapEnt, const char *filename,
