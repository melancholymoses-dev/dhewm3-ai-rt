...
==================
*/
int idCollisionModelManagerLocal::TransformedPointContents(const idVec3 &p, cmHandle_t model, const idVec3 &origin,
...
==================
*/
int idCollisionModelManagerLocal::ContentsTrm(trace_t *results, const idVec3 &start, const idTraceModel *trm,
                                              ...
                                              const idVec3 &modelOrigin, const idMat3 &modelAxis)
{
                 ...
                 trm->bounds[1][2] - trm->bounds[0][2] <= 0.0f))
    {
        ...
        results->c.contents =
            idCollisionModelManagerLocal::TransformedPointContents(start, model, modelOrigin, modelAxis);
...
==================
*/
int idCollisionModelManagerLocal::Contents(const idVec3 &start, const idTraceModel *trm, const idMat3 &trmAxis,
