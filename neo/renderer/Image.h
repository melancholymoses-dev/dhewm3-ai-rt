...
class idImage
{
  public:
    ...
    void GenerateCubeImage(const byte *pic[6], int size, textureFilter_t filter, bool allowDownSize,
...
void R_WritePalTGA(const char *filename, const byte *data, const byte *palette, int width, int height,
