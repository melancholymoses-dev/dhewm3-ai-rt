...
void R_CreateEntityRefs(idRenderEntityLocal *def)
{
    ...
    if (r_showUpdates.GetBool() && (def->referenceBounds[1][0] - def->referenceBounds[0][0] > 1024 ||
...
=====================
*/
void R_SetLightProject(idPlane lightProject[4], const idVec3 origin, const idVec3 target, const idVec3 rightVector,
...
void R_CreateLightRefs(idRenderLightLocal *light)
{
    ...
    if (r_showUpdates.GetBool() &&
        (tri->bounds[1][0] - tri->bounds[0][0] > 1024 || tri->bounds[1][1] - tri->bounds[0][1] > 1024))
    {
