...
// RTLight, RT_LIGHT_MAX_LIGHTS and the GI_LIGHT_FLAG_* bits. The buffer block
// below is ours; the struct is shared with the volumetric and probe consumers.
...
{
    return rt_LightFastScale(rtLightBuf.lights[i]);
}
