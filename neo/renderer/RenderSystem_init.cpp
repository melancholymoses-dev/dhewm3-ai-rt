...
idCVar r_inhibitFragmentProgram("r_inhibitFragmentProgram", "0", CVAR_RENDERER | CVAR_BOOL,
...
idCVar r_displayRefresh("r_displayRefresh", "0", CVAR_RENDERER | CVAR_INTEGER | CVAR_NOCHEAT,
                        "optional display refresh rate option for vid mode", 0.0f, 200.0f);
idCVar r_fullscreen("r_fullscreen", "0", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_BOOL, "0 = windowed, 1 = full screen");
idCVar r_fullscreenDesktop("r_fullscreenDesktop", "0", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_BOOL,
                           "0: 'real' fullscreen mode 1: keep resolution 'desktop' fullscreen mode");
idCVar r_customWidth("r_customWidth", "720", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_INTEGER,
                     "custom screen width. set r_mode to -1 to activate");
idCVar r_customHeight("r_customHeight", "486", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_INTEGER,
...
idCVar r_useShadowProjectedCull("r_useShadowProjectedCull", "1", CVAR_RENDERER | CVAR_BOOL,
                                "discard triangles outside light volume before shadowing");
idCVar r_useShadowVertexProgram("r_useShadowVertexProgram", "1", CVAR_RENDERER | CVAR_BOOL,
...
idCVar r_useDeferredTangents("r_useDeferredTangents", "1", CVAR_RENDERER | CVAR_BOOL,
...
idCVar r_useVertexBuffers("r_useVertexBuffers", "1", CVAR_RENDERER | CVAR_INTEGER,
                          "use ARB_vertex_buffer_object for vertexes", 0, 1, idCmdSystem::ArgCompletion_Integer<0, 1>);
idCVar r_useIndexBuffers("r_useIndexBuffers", "0", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_INTEGER,
                         "use ARB_vertex_buffer_object for indexes", 0, 1, idCmdSystem::ArgCompletion_Integer<0, 1>);
...
idCVar r_rtFlashlightBias("r_rtFlashlightBias", "20", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_FLOAT,
...
idCVar r_usePreciseTriangleInteractions("r_usePreciseTriangleInteractions", "0", CVAR_RENDERER | CVAR_BOOL,
...
idCVar r_useLightCulling("r_useLightCulling", "3", CVAR_RENDERER | CVAR_INTEGER,
                         "0 = none, 1 = box, 2 = exact clip of polyhedron faces, 3 = also areas", 0, 3,
...
idCVar r_testStepGamma("r_testStepGamma", "0", CVAR_RENDERER | CVAR_FLOAT,
                       "if > 0 draw a grid pattern to test gamma levels");
...
idCVar r_useCombinerDisplayLists("r_useCombinerDisplayLists", "1", CVAR_RENDERER | CVAR_BOOL | CVAR_NOCHEAT,
                                 "put all nvidia register combiner programming in display lists");
idCVar r_useDepthBoundsTest("r_useDepthBoundsTest", "1", CVAR_RENDERER | CVAR_BOOL,
...
idCVar r_forceLoadImages("r_forceLoadImages", "0", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_BOOL,
...
idCVar r_showLightScale("r_showLightScale", "0", CVAR_RENDERER | CVAR_BOOL,
...
idCVar r_showInteractions("r_showInteractions", "0", CVAR_RENDERER | CVAR_BOOL,
...
idCVar r_scaleMenusTo43("r_scaleMenusTo43", "1", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_BOOL,
                        "Scale menus, fullscreen videos and PDA to 4:3 aspect ratio");
// DG: the fscking patent has finally expired
idCVar r_useCarmacksReverse("r_useCarmacksReverse", "1", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_BOOL,
        ...
        for (i = 0; i < 6; i++)
        {
            for (int x = 0; x < outSize; x++)
            {
                for (int y = 0; y < outSize; y++)
                {
                    ...
                    dir = cubeAxis[i][0] + -(-1 + 2.0 * x / (outSize - 1)) * cubeAxis[i][1] +
...
{
    cmdSystem->AddCommand("MakeMegaTexture", idMegaTexture::MakeMegaTexture_f, CMD_FL_RENDERER | CMD_FL_CHEAT,
    ...
    cmdSystem->AddCommand("reportImageDuplication", R_ReportImageDuplication_f, CMD_FL_RENDERER,
