...
void idRenderModelLiquid::Update(void)
{
    ...
    case 0:
        for (y = 1; y < verts_y - 1; y++)
        {
            ...
            {
                value = (p2[x + verts_x] + p2[x - verts_x] + p2[x + 1] + p2[x - 1] + p2[x - verts_x - 1] +
                         p2[x - verts_x + 1] + p2[x + verts_x - 1] + p2[x + verts_x + 1] + p2[x]) *
                            (2.0f / 9.0f) -
                        p1[x];
    ...
    case 1:
        for (y = 1; y < verts_y - 1; y++)
        {
            ...
            {
                value = (p2[x + verts_x] + p2[x - verts_x] + p2[x + 1] + p2[x - 1] + p2[x - verts_x - 1] +
                         p2[x - verts_x + 1] + p2[x + verts_x - 1] + p2[x + verts_x + 1]) *
                            0.25f -
                        p1[x];
