...
class idRenderModelStatic : public idRenderModel
{
  public:
    ...
    virtual idRenderModel *InstantiateDynamicModel(const struct renderEntity_s *ent, const struct viewDef_s *view,
...
class idRenderModelMD3 : public idRenderModelStatic
{
  ...
  private:
    ...
    void LerpMeshVertexes(srfTriangles_t *tri, const struct md3Surface_s *surf, const float backlerp, const int frame,
