...
// Fills a VkDescriptorImageInfo (view + sampler) for a combined-image-sampler write.
// Returns false when img is null or has no Vulkan backend data (caller should use fallback).
