...
const char *ui_skinArgs[] = {"skins/characters/player/marine_mp",
                             ...
                             NULL};
#else
const char *ui_skinArgs[] = {"skins/characters/player/marine_mp",        "skins/characters/player/marine_mp_red",
                             "skins/characters/player/marine_mp_blue",   "skins/characters/player/marine_mp_green",
                             "skins/characters/player/marine_mp_yellow", NULL};
#endif
...
struct gameVersion_s
{
    gameVersion_s(void)
    {
        sprintf(string, "%s.%d%s %s-%s %s %s", ENGINE_VERSION, BUILD_NUMBER, BUILD_DEBUG, BUILD_OS, D3_ARCH, ID__DATE__,
                ID__TIME__);
    }
    char string[256];
} gameVersion;
...
#ifdef CTF
idCVar si_gameType("si_gameType", si_gameTypeArgs[0], CVAR_GAME | CVAR_SERVERINFO | CVAR_ARCHIVE,
                   "game type - singleplayer, deathmatch, Tourney, Team DM, Last Man or CTF", si_gameTypeArgs,
                   idCmdSystem::ArgCompletion_String<si_gameTypeArgs>);
#else
idCVar si_gameType("si_gameType", si_gameTypeArgs[0], CVAR_GAME | CVAR_SERVERINFO | CVAR_ARCHIVE,
                   "game type - singleplayer, deathmatch, Tourney, Team DM or Last Man", si_gameTypeArgs,
                   idCmdSystem::ArgCompletion_String<si_gameTypeArgs>);
#endif

idCVar si_map("si_map", "game/mp/d3dm1", CVAR_GAME | CVAR_SERVERINFO | CVAR_ARCHIVE, "map to be played next on server",
              idCmdSystem::ArgCompletion_MapName);
idCVar si_maxPlayers("si_maxPlayers", "8", CVAR_GAME | CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_INTEGER,
                     "max number of players allowed on the server", 1, 8);
...
idCVar si_usePass("si_usePass", "0", CVAR_GAME | CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_BOOL,
                  "enable client password checking");
idCVar si_pure("si_pure", "1", CVAR_GAME | CVAR_SERVERINFO | CVAR_BOOL,
...
idCVar si_serverURL("si_serverURL", "", CVAR_GAME | CVAR_SERVERINFO | CVAR_ARCHIVE,
                    "where to reach the server admins and get information about the server");

#ifdef CTF
// idCVar si_pointLimit(				"si_pointlimit",			"8",			CVAR_GAME | CVAR_SERVERINFO |
// CVAR_ARCHIVE | CVAR_INTEGER, "team points limit to win in CTF" );
...
idCVar ui_skin("ui_skin", ui_skinArgs[0], CVAR_GAME | CVAR_USERINFO | CVAR_ARCHIVE, "player skin", ui_skinArgs,
               idCmdSystem::ArgCompletion_String<ui_skinArgs>);
idCVar ui_team("ui_team", ui_teamArgs[0], CVAR_GAME | CVAR_USERINFO | CVAR_ARCHIVE, "player team", ui_teamArgs,
...
idCVar ui_ready("ui_ready", si_readyArgs[0], CVAR_GAME | CVAR_USERINFO, "player is ready to start playing",
                idCmdSystem::ArgCompletion_String<si_readyArgs>);
idCVar ui_spectate("ui_spectate", si_spectateArgs[0], CVAR_GAME | CVAR_USERINFO, "play or spectate",
...
idCVar g_doubleVision("g_doubleVision", "1", CVAR_GAME | CVAR_ARCHIVE | CVAR_BOOL,
                      "show double vision when taking damage");
idCVar g_hitEffect("g_hitEffect", "1", CVAR_GAME | CVAR_ARCHIVE | CVAR_BOOL,
...
#ifdef _D3XP
idCVar g_testPistolFlashlight("g_testPistolFlashlight", "1", CVAR_GAME | CVAR_BOOL,
...
idCVar g_countDown("g_countDown", "10", CVAR_GAME | CVAR_INTEGER | CVAR_ARCHIVE, "pregame countdown in seconds", 4,
                   3600);
...
idCVar g_TDMArrows("g_TDMArrows", "1", CVAR_GAME | CVAR_NETWORKSYNC | CVAR_BOOL,
...
idCVar g_voteFlags("g_voteFlags", "0", CVAR_GAME | CVAR_NETWORKSYNC | CVAR_INTEGER | CVAR_ARCHIVE,
...
idCVar mod_validSkins(
    ...
    "marine_mp_blue;skins/characters/player/marine_mp_red;skins/characters/player/marine_mp_yellow;skins/characters/"
    "player/marine_mp_purple;skins/characters/player/marine_mp_grey;skins/characters/player/marine_mp_orange",
