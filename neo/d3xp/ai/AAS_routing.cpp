                                 ...
                                 idReachability **reach) const
{
    ...
    *reach = NULL;
    ...
    for (i = 0; i < cluster->numPortals; i++)
    {
        ...
        // portal area. 			We cannot directly calculate the exact
        // travel time through the portal area 			because the
        // reachability used to travel into the portal area is not known.
