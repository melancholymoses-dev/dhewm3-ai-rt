...
class idAnim
{
  ...
  public:
    ...
    void SetAnim(const idDeclModelDef *modelDef, const char *sourcename, const char *animname, int num,
...
class idAnimBlend
{
  private:
    ...
    bool BlendAnim(int currentTime, int channel, int numJoints, idJointQuat *blendFrame, float &blendWeight,
...
class idAnimator
{
  public:
    ...
    void SetAFPoseJointMod(const jointHandle_t jointNum, const AFJointModType_t mod, const idMat3 &axis,
                           const idVec3 &origin);
