...
| Who else consumes it | Reflections now; AO + GI rgen in a follow-up commit | AO/GI currently use `rt_ReconstructNormal` too and will benefit (bump-mapped GI, fewer depth fetches), but keep the first PR small. |
